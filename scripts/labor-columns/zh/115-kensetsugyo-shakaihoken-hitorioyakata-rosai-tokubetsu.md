...
A. 有可能可以。完全不使用劳工的公司，无法加入中小事业主等的特别加入（第1种），因为其前提是劳工部分已成立劳灾保险的保险关系。另一方面，如建设业等省令所定种类的事业，以不使用劳工进行为常态时，即使是法人的代表者，也可能以一人亲方等（第2种・劳动者灾害补偿保险法第33条第3号）的身份，经由一人亲方团体特别加入。是否有代表者以外的董事、使用劳工的日数等会影响处理方式，个别可否须向加入的团体及所辖劳动局确认。
