...
畠山先生做的，是**减少自己事务所的作业**。本事务所着重的是**支持客户公司的实务工作**。主要服务为人事部外包方案（人事部丸投げプラン），包含工资计算、通常手续、劳务咨询，以及freee人事労務 Standard（スタンダード）与LINE打卡，不包含freee会計。

工资计算对象1～3人为**月费33,000日元起（含税）／初期导入与工作流程设计费88,000日元起（含税）**。初期费用包含freee设置、LINE打卡、工资体系与津贴／扣除设置、员工登记、社会保险信息、首次工资测试及工作流程设计。

**考勤资料的确认、核定，以及工资计算结果的最终批准由公司负责**。导入AI或软件，不表示事实确认及批准工作就不再需要。切换为自行处理时的支持范围、费用及数据转移需个别确认，不承诺一律免费支持或自动降价。另请参照[与自行处理的比较](/zh/labor/column/kyuyo-keisan-freee-naisei)及[顾问费的思考方式](/zh/labor/column/sharoushi-komonryo-nan-no-taika)。

**首次咨询60分钟内免费。** 若未签订顾问合同，第2次起每小时11,000日元（含税）。从“公司是否也能运用AI”的阶段，就可以咨询。

## 常见问题

**Q. 使用AI的话，顾问费会变便宜吗？**
A. 不会仅因使用AI就自动降低费用。人事部外包方案是包含工资计算、通常手续、咨询及系统的定额制服务。切换为自行处理会改变业务范围，因此支持内容与费用需个别确认。
...
- 四葉的服务内容与费用说明已更新为2026年9月9日V10规格。第三方公开案例的记述，仍依原先参阅日期的内容。
...
**本文并未决定到「该向谁咨询」为止。** 税务代理、税务文件制作及税务咨询是**税理士**的业务。本事务所并不承接，因此会请您直接委托税理士。本事务所不收取介绍费。劳动・社会保险的手续、就业规则、工资计算及其内制支援，由四葉社会保険労務士事務所承接。费用整理于[报酬额表](/zh/labor/ryokin)，常被询问的问题整理于[常见问答](/zh/labor/faq)。
