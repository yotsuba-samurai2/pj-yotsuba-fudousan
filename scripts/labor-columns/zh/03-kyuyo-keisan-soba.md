...
如第四行，也有导入软件、完全不委托代办的选择。这种情形下要委托社会保险劳务士什么、什么留在自家公司，整理于[导入了freee人事労務。那么，顾问社会保险劳务士要为我们做什么](/zh/labor/column/freee-jinji-roumu-sharoushi-doko-made)。此外，四葉将切换为这种「自行处理」形式的支援，纳入顾问合同的范围（详见后述）。
...
| | |
|---|---|
| 代办的费用 | 每位员工 **每月1,100日元（含税）** |
| 基本费用 | **无** |
| 前提 | ★**与顾问合同成套**。不承接仅有工资计算的委托 |
| 切换为内制的支援 | ★以freee**切换为自行计算的体制建构支援，包含在顾问费之内**（不另行收费） |
...
另外，还有**不委托代办**这个选择。以freee切换为自行计算的体制建构——初期设定的设计、工资项目与扣除的整理、保险费率修订时的确认、每月结算的咨询——都在顾问合同的范围内支援。此项支援不另行收费。代办（每人1,100日元）与内制哪一种较适合，也欢迎从整理阶段开始咨询。
...
**Q. 可以只委托工资计算吗？**
A. 四葉不承接。工资计算是与顾问合同成套承接的。若在没有咨询的情况下仅承接计算，恐怕会在未掌握实际情况下，以错误的前提进行处理。另外，本所将以freee切换为自行计算的体制建构支援，包含在顾问费之内。各事务所的方针不同，寻找单独承接的事务所也是一种选择。
