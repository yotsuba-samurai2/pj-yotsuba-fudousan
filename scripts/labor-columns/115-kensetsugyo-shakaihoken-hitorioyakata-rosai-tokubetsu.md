...
A. できる場合があります。労働者を1人も使用しない会社は、中小事業主等の特別加入（第1種）には入れません。労働者について労災保険の保険関係が成立していることが前提だからです。一方、建設業のように省令で定める種類の事業を、労働者を使用しないで行うことを常態としている場合は、法人の代表者でも一人親方等（第2種・労働者災害補償保険法第33条第3号）として、一人親方の団体を通じて特別加入できる場合があります。代表者以外の役員の有無や、労働者を使用する日数などで扱いが分かれるため、個別の可否は加入先の団体と所轄の労働局で確認が必要です。
