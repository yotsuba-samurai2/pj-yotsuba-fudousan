...
畠山先生做的，是**減少自己事務所的作業**。本事務所著重的是**支援客戶公司的實務工作**。主力服務為人事部外包方案（人事部丸投げプラン），包含薪資計算、通常手續、勞務諮詢，以及freee人事労務 Standard（スタンダード）與LINE打卡，不包含freee会計。

薪資計算對象1～3人為**月費33,000日圓起（含稅）／初期導入與作業流程設計費88,000日圓起（含稅）**。初期費用包含freee設定、LINE打卡、薪資體系與津貼／扣除設定、員工登錄、社會保險資訊、首次薪資測試及作業流程設計。

**出勤資料的確認、核定，以及薪資計算結果的最終核准由公司負責**。導入AI或軟體，不表示事實確認及核准工作就不再需要。切換為自行處理時的支援範圍、費用及資料移轉需個別確認，不承諾一律免費支援或自動降價。另請參照[與自行處理的比較](/zh-tw/labor/column/kyuyo-keisan-freee-naisei)及[顧問費的思考方式](/zh-tw/labor/column/sharoushi-komonryo-nan-no-taika)。

**首次諮詢60分鐘內免費。** 若未簽訂顧問契約，第2次起每小時11,000日圓（含稅）。從「公司是否也能運用AI」的階段，就可以諮詢。

## 常見問題

**Q. 使用AI的話，顧問費會變便宜嗎？**
A. 不會僅因使用AI就自動降低費用。人事部外包方案是包含薪資計算、通常手續、諮詢及系統的定額制服務。切換為自行處理會改變業務範圍，因此支援內容與費用需個別確認。
...
- 四葉的服務內容與費用說明已更新為2026年9月9日V10規格。第三方公開案例的記述，仍依原先參閱日期的內容。
...
**本文並未決定到「該向誰諮詢」為止。** 稅務代理、稅務文件製作及稅務諮詢是**稅理士**的業務。本事務所並不承接，因此會請您直接委託稅理士。本事務所不收取介紹費。勞動・社會保險的手續、就業規則、薪資計算及其內製支援，由四葉社会保険労務士事務所承接。費用整理於[報酬額表](/zh-tw/labor/ryokin)，常被詢問的問題整理於[常見問答](/zh-tw/labor/faq)。
