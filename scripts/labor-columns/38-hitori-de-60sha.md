...
畠山さんがやったのは、**自分の事務所の作業を減らすこと**でした。当事務所が力を入れているのは、**お客さまの会社の実務を支えること**です。主商品は、給与計算・通常手続・労務相談にfreee人事労務スタンダードとLINE打刻を含む人事部丸投げプランです。freee会計は含みません。

給与計算対象1〜3名で**月額33,000円〜（税込）／初期導入・運用設計費88,000円〜**（税込）です。初期費用には、freee設定、LINE打刻、給与体系・手当控除設定、従業員登録、社会保険情報、初回給与テスト、運用フロー設計を含みます。

**勤怠の確認・確定と給与計算結果の最終承認は会社側**です。AIやソフトの導入だけで事実確認や承認まで不要になるわけではありません。内製へ切り替える際の支援範囲・費用・データ移管は個別に確認し、一律の無料支援や自動的な値下げを約束するものではありません。[内製との比較](/labor/column/kyuyo-keisan-freee-naisei)と[顧問料の考え方](/labor/column/sharoushi-komonryo-nan-no-taika)もご覧ください。

**初回相談は60分まで無料です。** 顧問契約に至らない場合の2回目以降は1時間11,000円（税込）です。「うちもAIで何かできないか」という段階からご相談いただけます。

## よくある質問

**Q. AIを使えば、顧問料は安くなりますか？**
A. AIを使うことだけで料金が自動的に下がる設計ではありません。人事部丸投げプランは給与計算・通常手続・相談・システムを含む定額制です。内製への切替は業務範囲が変わるため、支援内容と料金を個別に確認します。
...
- 四葉のサービス内容・料金の説明は2026年9月9日のV10仕様に更新しています。第三者の公開事例に関する記述は従前の参照日時点のものです。
...
**この記事は、誰に相談するかまでは決めていません。** 税務代理・税務書類の作成・税務相談は**税理士**の業務です。当事務所では取り扱っておりませんので、税理士へ直接ご依頼いただく形をご案内します。当事務所は紹介料を受け取りません。労働・社会保険の手続、就業規則、給与計算とその内製支援は、四葉社会保険労務士事務所で承ります。費用は[報酬額表](/labor/ryokin)に、よくいただくご質問は[よくあるご質問](/labor/faq)にまとめています。
