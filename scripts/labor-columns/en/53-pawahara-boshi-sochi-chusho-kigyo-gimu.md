...
keywords: power harassment prevention measures small business obligation | power harassment consultation desk | power harassment three elements six types | power harassment work rules disciplinary action | is power harassment training mandatory | power harassment guideline 2026 revision | jibaku eigyo power harassment
tags: Power harassment | Prevention measures | Consultation desk | Work rules | Guideline revision 2026 | Labor management
---
...
Judging whether a particular disciplinary action is valid is not handled by this office; we refer you to a lawyer. Do not act on a disciplinary measure before the rules are in place. On the work rules themselves, see our [article on work rules](/en/labor/column/shugyokisoku-10nin-gimu-nani-ga-hitsuyo).
...
Note that from the same date, 1 October 2026, measures against customer harassment and against sexual harassment toward job applicants and others become new obligations for employers. Those are separate frameworks with different scope and content, so please see our [article on customer harassment measures](/en/labor/column/kasuhara-taisaku-2026-10-gimu).

## So what should the company put in place?

In order, there are seven things.

1. Set out, in the work rules or other service regulations, the policy that power harassment must not occur together with the policy of dealing strictly with those responsible and the content of that response, and communicate it
2. Designate the consultation desk, prepare the staff and the procedure, and make them known
3. Create the intake form for when a report is received
4. Decide how fact-finding proceeds (whom to ask, what to ask, what to record)
5. Decide the standard forms of consideration for the person harmed, action toward the person responsible, and recurrence prevention
6. Establish information-handling rules that protect the privacy of the person reporting, the person responsible and others, and communicate both those rules and the prohibition on disadvantageous treatment for making a report or cooperating with an investigation
7. Check whether any practice could amount to jibaku eigyo, whether wording still reads "性自認," and whether any practice prohibits or coerces disclosure of sensitive personal information
