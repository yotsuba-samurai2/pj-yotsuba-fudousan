...
const ARTICLES: Array<{
  ...
  },
  {
    ...
    category: "社会保険",
    excerpt:
      "2027年10月から、短時間労働者の社会保険加入の「企業規模要件」が「51人以上」から「36人以上」へ拡大します。規模は原則として厚生年金保険の被保険者数で判定し（法人は同一法人全体）、2029年10月21人以上、2032年10月11人以上と段階的に縮小、2035年10月に企業規模要件は撤廃されます。賃金要件（月額8.8万円以上）は2026年10月撤廃予定です。対象者と加入手続、会社が準備すべきことを整理します。",
    keywords: [
      "社会保険 適用拡大 2027",
      "社会保険 36人以上 2027年10月",
      "パート 社会保険 企業規模要件",
