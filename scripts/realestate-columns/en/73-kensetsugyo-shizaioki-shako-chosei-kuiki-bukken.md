...
How the use zone and floor-area ratio move land prices is covered in [this article](https://luck428.com/column/yosekiritsu-hosei-tochine); how control-area land is handled is in [this article](https://luck428.com/column/chousei-kuiki-souzoku-tochi-baikyaku). See also [investment and commercial property](https://luck428.com/toushi) and [company formation and choosing an office](https://luck428.com/office).
...
**An administrative scrivener prepares the garage certificate for a passenger vehicle and the storage-place notification for a light vehicle.** How the green-plate garage works is in [this article on choosing trucking premises and a garage](https://luck428.com/column/unsou-eigyosho-shako-bukken-yoken); the treatment of a used-car showroom and stock-vehicle garage certificates is in [this article](https://luck428.com/column/chuko-sha-kobutsusho-tenjijo-hokan-bukken).
...
These can be lined up and checked before the contract, together with which clauses of a lease to read (see [this article](https://luck428.com/column/chintaishaku-keiyakusho-doko-wo-yomu)).
