...
const REQUIRED_HUB_LINKS: Record<string, string[]> = {
  ...
  "kensetsugyo-kyoka-yoken-keikan-sengi-zaisan": [
    "/legal/services",
    "/legal/nagare",
    "/legal/ryokin",
    "/legal/column/kaitai-koji-gyo-touroku-kensetsu-kyoka-chigai",
  ],
  "kaitai-koji-gyo-touroku-kensetsu-kyoka-chigai": [
    "/legal/services",
    "/legal/nagare",
    "/legal/ryokin",
    "/souzoku",
    "/legal/column/kensetsugyo-kyoka-yoken-keikan-sengi-zaisan",
    "/legal/column/sanpai-shushu-unpan-kyoka-torikata",
    "/legal/column/souzoku-touki-nagare",
  ],
  "kaigai-honkon-singapore-souzokunin-isanbunkatsu-shomei": [
    "/legal/services/inheritance",
    "/legal/nagare",
    "/legal/ryokin",
    "/souzoku",
  ...
  "ninka-gai-hoiku-shisetsu-secchi-todokede-kijun": [
    "/legal/services",
    "/legal/nagare",
    "/legal/ryokin",
    "/legal/column/houkago-day-jido-hattatsu-shitei-shinsei-nagare",
  ],
  "souzoku-nin-fuzai-seisannin-tokubetsu-enko": [
    "/legal/services/inheritance",
    "/legal/nagare",
    "/legal/ryokin",
    "/souzoku",
    ...
    "/legal/column/souzoku-tochi-kokko-kizoku",
    "/legal/column/shigojimu-inin-keiyaku-ohitorisama",
    "/legal/column/nini-koken-keiyaku-ikogata",
  ],
  "ryokogyo-touroku-shubetsu-yoken-nagare": [
    "/legal/services",
    "/legal/nagare",
    "/legal/ryokin",
    "/legal/column/ryokangyo-kani-shukujo-kyoka-shinsei",
  ],
  "koseki-koiki-kofu-2024-souzoku-tetsuzuki": [
    "/legal/services/inheritance",
    "/legal/nagare",
    "/legal/ryokin",
    "/souzoku",
  ...
  "fuzoku-eigyo-1go-settai-inshoku-kyoka-bukken-kyori": [
    "/legal/services",
    "/legal/nagare",
    "/legal/ryokin",
    "/legal/column/shinya-shurui-teikyo-todokede-yoken",
  ...
  "souzokubun-joto-tokubetsu-jueki-shomei": [
    "/legal/services/inheritance",
    "/legal/nagare",
    "/legal/ryokin",
    "/souzoku",
  ...
  "sanpai-shobun-gyo-chukan-shori-kyoka-shisetsu": [
    "/legal/services",
    "/legal/nagare",
    "/legal/ryokin",
    "/legal/column/sanpai-shushu-unpan-kyoka-torikata",
  ],
  "digital-isan-netbank-ango-shisan-souzoku": [
    "/legal/services/inheritance",
    "/legal/nagare",
    "/legal/ryokin",
    "/souzoku",
  ...
  "toroku-shien-kikan-touroku-shien-keikaku": [
    "/legal/services",
    "/legal/nagare",
    "/legal/ryokin",
  ],
  ...
  "kaihatsu-kyoka-toshikeikakuho-29jo-nagare": [
    ...
    "/legal/ryokin",
    "/souzoku",
    "/legal/column/nochi-tenyo-4jo-5jo-kyoka-nagare",
    "/legal/column/souzoku-touki-nagare",
  ],
...
const ARTICLES: Array<{
  ...
  {
    file: "49-kensetsugyo-kyoka-yoken-keikan-sengi-zaisan.md",
    slug: "kensetsugyo-kyoka-yoken-keikan-sengi-zaisan",
    date: "2026-09-07",
    title:
  ...
  {
    file: "50-kaitai-koji-gyo-touroku-kensetsu-kyoka-chigai.md",
    slug: "kaitai-koji-gyo-touroku-kensetsu-kyoka-chigai",
    date: "2026-09-07",
    title:
  ...
  {
    file: "51-kaigai-honkon-singapore-souzokunin-isanbunkatsu-shomei.md",
    slug: "kaigai-honkon-singapore-souzokunin-isanbunkatsu-shomei",
    date: "2026-09-07",
    title:
    ...
    keywords: [
      "海外在住 相続人 遺産分割協議書 署名証明",
      "香港 シンガポール 相続 サイン証明",
      "在外公館 署名証明 在留証明 相続",
      "外国籍 相続人 公証人 Notary Public",
      "遺産分割協議書 印鑑証明 代わり 海外",
      "香港 シンガポール 相続 行政書士",
    ],
    tags: [
  ...
  {
    file: "52-ninka-gai-hoiku-shisetsu-secchi-todokede-kijun.md",
    slug: "ninka-gai-hoiku-shisetsu-secchi-todokede-kijun",
    date: "2026-09-08",
    title:
    ...
    keywords: [
      "認可外保育施設 設置届 児童福祉法59条の2",
      "認可外保育施設指導監督基準 面積 保育従事者",
      "認可外 認可 小規模認可 企業主導型 違い",
      "ベビーホテル 定義 認可外保育施設",
      "認可外保育施設 無届 過料 事業停止",
      "認可外保育施設 開設 行政書士",
    ],
  ...
  {
    file: "53-souzoku-nin-fuzai-seisannin-tokubetsu-enko.md",
    slug: "souzoku-nin-fuzai-seisannin-tokubetsu-enko",
    date: "2026-09-08",
    title:
    ...
    keywords: [
      "相続人がいない 相続財産清算人 選任",
      "相続財産清算人 特別縁故者 財産分与",
      "特別縁故者 内縁 療養看護 民法958条の2",
      "相続財産清算人 相続財産管理人 違い 改正",
      "相続人不存在 国庫帰属 民法959条",
      "相続人がいない 相続 行政書士",
    ],
    tags: [
  ...
  {
    file: "54-ryokogyo-touroku-shubetsu-yoken-nagare.md",
    slug: "ryokogyo-touroku-shubetsu-yoken-nagare",
    date: "2026-09-09",
    title:
    ...
    keywords: [
      "旅行業登録 種別 第1種 第2種 第3種 地域限定",
      "旅行業 登録 要件 基準資産額",
      "旅行業 営業保証金 旅行業法第7条",
      "旅行業務取扱管理者 選任 旅行業法第11条の2",
      "着地型ツアー 旅行業登録 必要か",
      "旅行業登録 行政書士",
    ],
    tags: [
  ...
  {
    file: "55-koseki-koiki-kofu-2024-souzoku-tetsuzuki.md",
    slug: "koseki-koiki-kofu-2024-souzoku-tetsuzuki",
    date: "2026-09-09",
    title:
      "戸籍の広域交付で相続の戸籍集めは楽になったのか？使えない場面はどこか",
    category: "相続の手続き（行政書士の実務から）",
    excerpt:
      "2024年（令和6年）3月1日施行の戸籍の広域交付（戸籍法第120条の2）により、本籍地以外の最寄りの市区町村の窓口で複数の戸籍謄本（全部事項証明書）等をまとめて請求できるようになりました。請求できるのは本人・配偶者・直系尊属・直系卑属に限られ、郵送・代理人請求は不可で顔写真付きの本人確認書類が必要、コンピュータ化されていない一部の戸籍や一部事項証明書・個人事項証明書は対象外です。適用範囲と従来手続との併用を整理し、登記は司法書士又は弁護士、税務は税理士へ分離受任で振る分担をまとめました。",
    keywords: [
      "戸籍 広域交付 戸籍法120条の2",
      "戸籍 広域交付 使えない 対象外",
      "広域交付 請求できる人 直系 兄弟姉妹",
  ...
  {
    file: "56-fuzoku-eigyo-1go-settai-inshoku-kyoka-bukken-kyori.md",
    slug: "fuzoku-eigyo-1go-settai-inshoku-kyoka-bukken-kyori",
    date: "2026-09-10",
    title:
  ...
  {
    file: "57-souzokubun-joto-tokubetsu-jueki-shomei.md",
    slug: "souzokubun-joto-tokubetsu-jueki-shomei",
    date: "2026-09-10",
    title:
  ...
  {
    file: "58-sanpai-shobun-gyo-chukan-shori-kyoka-shisetsu.md",
    slug: "sanpai-shobun-gyo-chukan-shori-kyoka-shisetsu",
    date: "2026-09-11",
    title:
      "産業廃棄物処分業（中間処理）の許可｜施設設置と用途・生活環境調査",
    category: "許認可・各種申請（行政書士の実務から）",
    excerpt:
  ...
  {
    file: "59-digital-isan-netbank-ango-shisan-souzoku.md",
    slug: "digital-isan-netbank-ango-shisan-souzoku",
    date: "2026-09-11",
    title:
  ...
  {
    file: "60-toroku-shien-kikan-touroku-shien-keikaku.md",
    slug: "toroku-shien-kikan-touroku-shien-keikaku",
    date: "2026-09-12",
    title:
      "登録支援機関の登録と支援計画｜特定技能の受入れで行政書士が担う範囲",
    category: "許認可（行政書士の実務から）",
    excerpt:
      "登録支援機関は、特定技能1号外国人の受入れ機関から一号特定技能外国人支援計画の全部の実施の委託を受け、出入国在留管理庁長官の登録を受けて支援を行う機関です。登録の要件・欠格事由（出入国管理及び難民認定法第19条の23・第19条の26）、支援計画の義務的支援10項目（平成31年法務省令第5号）、自社支援の条件、変更・休廃止の届出と登録取消しを整理し、労働条件・社会保険は社会保険労務士、課税は税理士へ分離受任で振る分担をまとめました。",
    keywords: [
      "登録支援機関 登録 要件",
      "一号特定技能外国人支援計画 項目",
      "登録支援機関 欠格事由 取消",
  ...
  {
    file: "61-saishi-shokei-haka-butsudan-isanbunkatsu.md",
    slug: "saishi-shokei-haka-butsudan-isanbunkatsu",
    date: "2026-09-12",
    title:
  ...
  {
    file: "62-kaihatsu-kyoka-toshikeikakuho-29jo-nagare.md",
    slug: "kaihatsu-kyoka-toshikeikakuho-29jo-nagare",
    date: "2026-09-13",
    title:
  ...
  {
    file: "63-tokutei-zaisan-shokei-yuigon-izo-chigai.md",
    slug: "tokutei-zaisan-shokei-yuigon-izo-chigai",
    date: "2026-09-13",
    title:
  ...
  {
    file: "66-koshu-yokujo-sauna-eigyo-kyoka-shinsei.md",
    slug: "koshu-yokujo-sauna-eigyo-kyoka-shinsei",
    date: "2026-09-16",
    title:
  ...
  {
    file: "67-tokubetsu-kiyoryo-souzokunin-igai-shinzoku.md",
    slug: "tokubetsu-kiyoryo-souzokunin-igai-shinzoku",
    date: "2026-09-16",
    title:
