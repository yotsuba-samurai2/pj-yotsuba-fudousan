...
const ARTICLES: Array<{
  ...
  },
  {
    ...
    excerpt:
      "他人の物品を有償で預かる営業倉庫を業として営むには、倉庫業法第3条の登録が必要です。登録の可否は、預かる物品に応じた倉庫の種類（一類・二類・三類・野積・貯蔵槽・危険品・冷蔵・水面・トランクルーム）ごとの施設設備基準（倉庫業法第6条第1項第4号・同施行規則第3条の4）に物件が適合するかで決まります。倉庫管理主任者の選任要件（同法第11条・施行規則第9条）、既存倉庫の転用時の確認点、登録申請は行政書士・物件選定は不動産・建築確認は建築士・消防は消防署へ振り分ける分離受任を整理しました。",
    keywords: [
      "倉庫業 登録 要件 物件",
      "営業倉庫 施設設備基準 倉庫業法",
  ...
  {
    file: "78-shuro-keizoku-shien-ab-shitei-shinsei-youken.md",
    slug: "shuro-keizoku-shien-ab-shitei-shinsei-youken",
    date: "2026-09-23",
    title:
      "就労継続支援A型・B型の指定を受けるには、どんな要件と手続きが必要ですか？",
    category: "障害福祉の許認可（行政書士の実務から）",
    excerpt:
      "就労継続支援は障害者総合支援法第5条第15項の障害福祉サービスで、A型は雇用契約に基づく就労、B型は雇用契約によらない生産活動を提供します。指定（同法第36条）の人員基準（職業指導員・生活支援員は常勤換算で利用者数を10で除した数以上、サービス管理責任者）、設備・運営基準、申請の流れ、A型の最低賃金とB型の工賃（月額3,000円が原則の下限）、報酬告示や実地指導の要点を、平成18年厚生労働省令第171号に沿って整理。労務は社会保険労務士、物件・建築は不動産会社・建築士、登記は司法書士、税務は税理士へ振り分ける分離受任を明示しました。",
    keywords: [
      "就労継続支援 A型 B型 指定 要件",
      "就労継続支援 指定申請 人員基準",
      "就労継続支援A型 B型 違い 雇用契約",
      "サービス管理責任者 職業指導員 生活支援員 配置",
      "就労継続支援 設備基準 利用定員 20人",
      "就労継続支援 行政書士 指定申請",
    ],
    tags: [
      "就労継続支援",
  ...
  {
    file: "79-souzoku-hijojo-kabushiki-isanbunkatsu-kyogi.md",
    slug: "souzoku-hijojo-kabushiki-isanbunkatsu-kyogi",
    date: "2026-09-23",
    title:
      "相続財産に同族会社の非上場株式が含まれるとき、遺産分割協議はどう進めますか？",
    category: "相続の手続き（行政書士の実務から）",
    excerpt:
      "被相続人が持っていた同族会社の非上場株式も相続財産で、遺産分割の対象です。分割前は相続人全員の準共有となり（民法第898条・第264条）、権利行使者を定めて会社に通知しなければ権利を行使できません（会社法第106条、最判平成9年1月28日・平成27年2月19日）。評価が食い違う理由（財産評価基本通達の類似業種比準・純資産価額・配当還元方式）、後継者に集める代償分割、協議書の書き方、会社法第133条の株主名簿の名義書換までを整理。評価・相続税は税理士、不動産の相続登記は司法書士、紛争は弁護士へ振り分ける分離受任を明示しました。",
    keywords: [
      "非上場株式 遺産分割 協議",
      "株式 準共有 権利行使者 会社法106条",
      "非上場株式 評価 相続 食い違い",
      "後継者 株式 集中 代償分割",
      "株主名簿 名義書換 相続 会社法133条",
      "同族会社 株式 相続 行政書士",
    ],
    tags: [
      "非上場株式",
