...
export const BUSINESS_SEO: Record<string, BusinessSEOConfig> = {
  realestate: {
    ...
    legalName: "四葉不動産株式会社",
    description:
      "元新聞記者が中国や台湾、タイでの駐在経験を活かして立ち上げた、東京都文京区にある不動産屋。賃貸・売買・管理から相続不動産まで、多言語（日本語・英語・中国語繁体字・中国語簡体字）対応と専門家ネットワークで住まい探しから契約まで対応。相続書類・許認可は併設の四葉行政書士事務所が別契約で受任します。初回相談は無料、お気軽にどうぞ。",
