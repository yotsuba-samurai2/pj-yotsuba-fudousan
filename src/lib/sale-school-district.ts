...
export const SCHOOL_SALE_COPY = {
  ja: { indexTitle: "文京区の小学校区から物件を探す", title: "{school}区の売買物件", view: "この学区の売買物件を見る", count: "売出中 {count}件", rental: "賃貸 {count}件", sale: "売買 {count}件", condo: "マンション", house: "戸建て", land: "売地", all: "すべて", empty: "現在、この条件でご紹介できる売買物件はありません。", lead: "文京区の賃貸と売買（マンション・戸建て・売地）の取扱物件を小学校区別にご案内します。各学区から賃貸一覧または売買一覧へ進めます。売買物件は、マンションの専有面積、戸建ての建物面積または売地の土地面積が55㎡以上で、所在地から学区を確認できた公開物件を掲載しています。", request: "この学区の購入を相談する", back: "すべての学区の売買物件を見る" },
  en: { indexTitle: "Find properties by school district in Bunkyo", title: "Properties for sale in the {school} district", view: "View properties for sale in this district", count: "{count} for sale", rental: "Rentals: {count}", sale: "For sale: {count}", condo: "Condominiums", house: "Houses", land: "Land", all: "All", empty: "No properties are currently listed for these criteria.", lead: "Explore our rental and for-sale properties in Bunkyo by elementary school district. Each district links to its rental and sales listings. Sales listings have at least 55 m² of exclusive floor area for condominiums, building floor area for houses, or land area for plots, and an address that can be matched to a school district.", request: "Ask about buying in this school district", back: "View sales in all school districts" },
  "zh-tw": { indexTitle: "依文京區小學學區尋找物件", title: "{school}學區的出售物件", view: "查看此學區的出售物件", count: "出售中 {count}件", rental: "出租 {count}件", sale: "出售 {count}件", condo: "公寓", house: "獨棟住宅", land: "土地", all: "全部", empty: "目前沒有符合此條件的出售物件。", lead: "依小學學區介紹本公司經手的文京區出租與出售物件（公寓、獨棟住宅及土地）。可由各學區前往出租或出售物件一覽。出售公寓專有面積、獨棟住宅建築面積或土地面積須達55平方公尺，且地址可確認學區。", request: "諮詢此學區的購屋", back: "查看所有學區的出售物件" },
  zh: { indexTitle: "按文京区小学学区查找房源", title: "{school}学区的出售房源", view: "查看此学区的出售房源", count: "出售中 {count}套", rental: "出租 {count}套", sale: "出售 {count}套", condo: "公寓", house: "独栋住宅", land: "土地", all: "全部", empty: "目前没有符合此条件的出售房源。", lead: "按小学学区介绍本公司经手的文京区出租与出售房源（公寓、独栋住宅及土地）。可从各学区进入出租或出售房源列表。出售公寓专有面积、独栋住宅建筑面积或土地面积须达到55平方米，且地址可确认学区。", request: "咨询此学区的购房", back: "查看所有学区的出售房源" },
