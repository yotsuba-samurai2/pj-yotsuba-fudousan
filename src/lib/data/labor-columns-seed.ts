  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "人数の帯を目安にしています。ただし顧問料はご相談の対価なので、帯はご相談の内容と量で決めます。人数が少なくてもご相談が多ければ上の帯を、人数が多くてもご相談が少なければ下の帯をお見積りすることがあります。目安としては、〜4人で月22,000円（税込）から始まり、25〜29人の77,000円（税込）まで、5人刻みの階段になっています。30人以上は個別にお見積りです。30人を超えるあたりから、部署ごとに就業実態が分かれ、非正規の類型や労使協定の本数が増えて、相談の重さが人数に比例しなくなるためです。一律の階段に載せると、実態の軽い会社から取りすぎるか、重い会社を安く受けすぎるかのどちらかになります。従業員数は被保険者数を目安に判断します。"
      },
      {
