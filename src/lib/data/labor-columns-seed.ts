...
export const LABOR_COLUMNS_SEED: LaborSeedColumn[] = [
  ...
  },
  {
    ...
    "faq": [
      {
        "question": "freeeで電子申請までできるなら、社会保険労務士に頼む意味はありますか？",
        "answer": "自社の手続を自社で出す作業は、ソフトでできます。社会保険労務士に頼むのは、その手続が要るのか・いつまでか・どの給付が使えるかという判断と、報酬を得て代わりに行える作成・提出代行・事務代理（社会保険労務士法第2条第1項第1号〜第1号の3）です。作業と判断は別のものです。"
      },
      {
        "question": "freeeの電子申請には、何が必要ですか？",
        "answer": "公式ヘルプ（2026年8月14日参照）によると、gBizIDプライムアカウントが必要で、法人事業所のみが対象です。経路はマイナポータルとe-Govの2つに分かれます。機能や対応書類は改定されるため、最新の範囲はfreeeの公式ヘルプでご確認ください。"
      },
      {
        "question": "顧問の社会保険労務士は、freeeの中から代理申請してくれるのですか？",
        "answer": "freeeの公式ヘルプには「社労士による代理人申請には現在対応しておりません」（2026年4月10日更新）と明記されています。代理で申請する場合は、社会保険労務士側の仕組みで行います。freee人事労務をお使いのまま頼めますので、ソフトの入れ替えは不要です。"
      },
      {
        "question": "年末調整も社会保険労務士に頼めますか？",
        "answer": "freee人事労務に年末調整の機能はありますが、報酬を得て代わりに行うのは税務の領域で、税理士の業務です。当事務所では取り扱っておらず、税理士に直接ご依頼いただく形をご案内しています。紹介料の授受はありません。"
      }
    ],
    "translations": {
      "en": {
        "title": "We've brought in freee HR. So what does a retained shakai hoken roumushi actually do?",
        "excerpt": "freee HR prepares the documents and can file them electronically through Mynaportal or e-Gov. As long as your company files its own procedures for itself, no licence is required. A shakai hoken roumushi becomes necessary when someone prepares or files them on another's behalf, for a fee. We draw the line by the statute itself.",
        "content": "**In short:** freee HR (freee人事労務) prepares the documents and can file them electronically through Mynaportal or e-Gov. **As long as your company files its own procedures for itself, no licence is required.** A shakai hoken roumushi (Certified Social Insurance and Labor Consultant) becomes necessary when someone **prepares or files them on another person's behalf, for a fee, at that person's request** (Certified Social Insurance and Labor Consultant Act, Article 27).\n\nThis page is for owners and back-office staff of small and medium-sized companies that have adopted freee HR, or are thinking about it. The software and the consultant are not substitutes for each other; the line between them simply runs in a different place. We trace that line along the statute.\n\n## How far can freee HR alone take you?\n\nAccording to freee's official help pages (updated 10 April 2026, viewed 14 August 2026), electronic filing from freee HR runs through **two routes — Mynaportal and e-Gov** — and requires a **gBizID Prime account** (corporate accounts only; the free tier is not covered).\n\n| Route | Documents that can be filed electronically (examples) |\n|---|---|\n| Mynaportal | The monthly standard remuneration revision notification (月額変更届), the annual standard remuneration calculation report (算定基礎届), the bonus payment notification (賞与支払届), acquisition and loss of insured status notifications for health insurance and employees' pension (資格取得届・喪失届), employment insurance acquisition and loss notifications (with or without the separation certificate), and application forms for childcare-leave benefits and continued-employment benefits for older workers, among others |\n| e-Gov | The annual renewal of labour insurance (年度更新), the periodic health checkup results report, and the stress-check results report |\n\nIn other words, filing your own company's procedures for yourself — the social and employment insurance filings that come with hiring and departures, the annual calculation report, the annual renewal — **is something the software can do**.\n\nTwo cautions. First, freee's features and the list of supported documents change. The table above reflects **published materials as of August 2026**; check the official help pages for the current scope. Second, the same help page states plainly: **\"agent filing by a shakai hoken roumushi is not currently supported.\"** Electronic filing in freee HR is designed as **a tool for an employer to file its own procedures itself**.\n\n## If the software exists, why would we need a shakai hoken roumushi?\n\nThe Certified Social Insurance and Labor Consultant Act defines three types of work concerning labour and social insurance procedures (Article 2, paragraph 1).\n\n| Item | Work | What it means |\n|---|---|---|\n| Item 1 | **Preparing** applications and other documents | Drawing up the applications, notifications and reports submitted to public agencies |\n| Item 1-2 | **Filing on another's behalf** | Carrying out the submission procedures for those documents in another's place |\n| Item 1-3 | **Representation in procedures** | Acting as agent in applications, and in statements and assertions made to the agency in investigations and dispositions |\n\nThere is a phrase here that is easy to miss. The statutory definition of \"applications and other documents\" in item 1 expressly **includes electronic or magnetic records (電磁的記録)** created in place of paper documents. That is: not only the paper notification, but **the data you build in cloud software and file electronically falls squarely within the statute**.\n\nArticle 27 then draws the line.\n\n> No person other than a shakai hoken roumushi or a shakai hoken roumushi corporation may, **at the request of another person and for a fee**, carry out **as a business** the affairs listed in Article 2, paragraph 1, items 1 through 2. (Certified Social Insurance and Labor Consultant Act, Article 27)\n\nRead in reverse: **a company handling its own procedures for itself is outside this provision.** You need no licence to prepare and file your own annual calculation report in freee. The licence is needed when someone does it **for another company, for a fee**. What the software removes is the labour of filing your own paperwork — not the legal character of having someone do it for you.\n\nArticle 27 has a proviso: work performed incidentally to business designated by cabinet order is exempt. The order (Order for Enforcement of the Certified Social Insurance and Labor Consultant Act, Article 2) designates two cases — **work performed by a certified public accountant as part of CPA practice, and work performed by a tax accountant or tax accountant corporation incidentally to tax practice**. Where exactly \"incidental\" ends is a case-by-case judgement, so this article goes no further than presenting the provision.\n\n## Accounting and labour: who do you ask for which?\n\nIn a company running freee, accounting and HR sit side by side on the same screen, so the question \"can't we just ask one person to handle everything?\" arises naturally. But the licensing lines are drawn somewhere other than the software's menus.\n\n| Software / situation | Doing it yourself | Whom to engage, for a fee, to do it for you |\n|---|---|---|\n| freee Accounting (bookkeeping, closing, tax returns) | No licence needed | **A tax accountant** |\n| freee HR (social and labour insurance procedures) | No licence needed | **A shakai hoken roumushi** |\n| freee HR's year-end adjustment feature | No licence needed | **A tax accountant** (the year-end adjustment is tax work) |\n| Licences and permits after freee Company Formation | No licence needed | **A gyoseishoshi** (Certified Administrative Procedures Legal Specialist) |\n\nIn Yotsuba's case, labour and social insurance procedures are handled by 四葉社会保険労務士事務所, and permits, residence status and subsidies by 四葉行政書士事務所. **They are independent businesses, with separate contracts and separate invoices.** For tax we point you to a tax accountant, whom you engage directly; **no referral fees change hands.**\n\n## What exactly is the retainer paying for, then?\n\nOnce the software takes over the typing and the filing, the consultant's work shifts away from \"writing documents\" to **what comes before and after them**.\n\n- Whether the procedure is **needed at all, and by when** (a judgement arises with every hire, departure and leave)\n- Whether the **requirements for a benefit are met**, and which benefits are available\n- Handling **investigations and inquiries** from the agencies (the representation in item 1-3 is the work for this situation)\n- The **labour management underneath the procedures** — working hours, wages, work rules\n\nFor a company that has adopted the software, the retained consultant looks less like an outsourced typist and more like the place you take judgement calls. How payroll pricing works, and where a shakai hoken roumushi fits, is set out in [How much does it cost to have a shakai hoken roumushi run payroll?](/en/labor/column/kyuyo-keisan-soba-sharoushi), and our own thinking on fees in the [fee schedule](/en/labor/ryokin). If the fees are not visible, there is nothing to compare — we take that view too.\n\n## What can 四葉社会保険労務士事務所 do?\n\n四葉社会保険労務士事務所, in Kohinata, Bunkyo City, handles the preparation, agent filing and procedural representation of labour and social insurance filings (Certified Social Insurance and Labor Consultant Act, Article 2, paragraph 1, items 1 through 1-3), together with labour consultation and the drafting and revision of work rules. If your company uses freee HR, **there is no need to switch software**. You keep filing what you can file yourselves, and hand over only the parts that need judgement or agent filing.\n\n**Consultation is free of charge.** Bring your freee settings screen, or the list of procedures you are about to file, and we will start by sorting them into \"things you can file yourselves\" and \"things better handed over\". The questions we are asked most often are collected on the [FAQ page](/en/labor/faq).\n\n### Whom to consult\n\nBookkeeping, closing, tax returns and the year-end adjustment are work for **a tax accountant**; registration for **a judicial scrivener**; matters already in dispute for **an attorney**. Residence-status applications, subsidies and company-formation documents are handled by **四葉行政書士事務所** (a separate business from this office, engaged under a separate contract). In every case, no referral fees change hands.\n\n## Frequently asked questions\n\n**Q. If freee can file electronically, is there any point in engaging a shakai hoken roumushi?**\nA. The work of filing your own procedures can be done by the software. What you engage a shakai hoken roumushi for is the **judgement** — whether a procedure is needed, by when, and which benefits apply — and the **preparation, agent filing and procedural representation** that only a licence-holder may perform for a fee (Certified Social Insurance and Labor Consultant Act, Article 2, paragraph 1, items 1 through 1-3). The work and the judgement are different things.\n\n**Q. What does electronic filing from freee require?**\nA. According to the official help pages (viewed 14 August 2026), a gBizID Prime account, and corporate accounts only. The routes divide into Mynaportal and e-Gov. Features and supported documents change, so check freee's official help for the current scope.\n\n**Q. Will a retained shakai hoken roumushi file as our agent from inside freee?**\nA. freee's official help states that \"agent filing by a shakai hoken roumushi is not currently supported\" (updated 10 April 2026). Agent filings are made through the consultant's own systems. You can stay on freee HR while engaging us — no need to switch software.\n\n**Q. Can we also ask a shakai hoken roumushi to do the year-end adjustment?**\nA. freee HR has a year-end adjustment feature, but performing it for another person for a fee is tax work — the province of **a tax accountant**. This office does not handle it; we point you to a tax accountant, whom you engage directly. No referral fees change hands.\n\n## Sources for this article\n\n- Certified Social Insurance and Labor Consultant Act (社会保険労務士法, Act No. 89 of 1968), **Article 2, paragraph 1, items 1, 1-2 and 1-3; Article 27** — current text confirmed on e-Gov on 14 August 2026\n- Order for Enforcement of the Certified Social Insurance and Labor Consultant Act (社会保険労務士法施行令, Cabinet Order No. 327 of 1968), **Article 2** — current text confirmed on e-Gov the same day\n- The scope of electronic filing in freee HR, the gBizID Prime requirement, and the non-support of agent filing by a shakai hoken roumushi — freee Help Center, \"Filing various documents electronically from freee HR\" (updated 10 April 2026, viewed 14 August 2026)\n\n**freee's features and supported documents change. When considering adoption or operation, check freee's official help pages for the latest information.** This article is based on materials published as of August 2026.\n\nHow far freee's AI features have come is set out in [How far has the AI integration between freee HR and freee Accounting actually come?](/en/labor/column/freee-jinji-kaikei-ai). Our fees are in the [fee schedule](/en/labor/ryokin), and the path from consultation to engagement in [How an engagement proceeds](/en/labor/nagare).\n\nThis article is general information. Judgments that fit your particular circumstances are made by a qualified professional after a meeting. Written by [Joji Uramatsu](/en/about/uramatsu) (Shakai Hoken Roumushi (Certified Social Insurance and Labor Consultant), Gyoseishoshi (Certified Administrative Procedures Legal Specialist), Registered Real Estate Transaction Specialist).",
        "category": "Who to ask",
        "keywords": [
          "freee HR shakai hoken roumushi what to ask",
          "freee electronic filing gBizID",
          "what does a retained labour consultant do",
          "scope of practice social insurance labor consultant electronic records",
          "freee year-end adjustment who to ask",
          "cloud payroll software do we still need a consultant"
        ],
        "tags": [
          "freee",
          "electronic filing",
        ...
        "faq": [
          {
            "question": "If freee can file electronically, is there any point in engaging a shakai hoken roumushi?",
            "answer": "The work of filing your own procedures can be done by the software. What you engage a shakai hoken roumushi for is the judgement — whether a procedure is needed, by when, and which benefits apply — and the preparation, agent filing and procedural representation that only a licence-holder may perform for a fee (Certified Social Insurance and Labor Consultant Act, Article 2, paragraph 1, items 1 through 1-3). The work and the judgement are different things."
          },
          {
            "question": "What does electronic filing from freee require?",
            "answer": "According to the official help pages (viewed 14 August 2026), a gBizID Prime account, and corporate accounts only. The routes divide into Mynaportal and e-Gov. Features and supported documents change, so check freee's official help for the current scope."
          },
          {
            "question": "Will a retained shakai hoken roumushi file as our agent from inside freee?",
            "answer": "freee's official help states that \"agent filing by a shakai hoken roumushi is not currently supported\" (updated 10 April 2026). Agent filings are made through the consultant's own systems. You can stay on freee HR while engaging us — no need to switch software."
          },
          {
            "question": "Can we also ask a shakai hoken roumushi to do the year-end adjustment?",
            "answer": "freee HR has a year-end adjustment feature, but performing it for another person for a fee is tax work — the province of a tax accountant. This office does not handle it; we point you to a tax accountant, whom you engage directly. No referral fees change hands."
          }
        ]
      },
      "zh-tw": {
        ...
        "faq": [
          {
            "question": "既然freee能做到電子申請，委託社會保險勞務士還有意義嗎？",
            "answer": "自家手續由自己提出的作業，軟體就能完成。委託社會保險勞務士的，是「這項手續需不需要辦・期限到何時・有哪些給付可用」的判斷，以及只有資格者才能收取報酬代辦的製作・提出代行・事務代理（社會保險勞務士法第2條第1項第1號〜第1號之3）。作業與判斷是兩回事。"
          },
          {
            "question": "freee的電子申請需要什麼？",
            "answer": "依官方說明頁（2026年8月14日參閱），需要gBizID Prime帳戶，且僅限法人事業所。路徑分為Mynaportal與e-Gov兩種。功能與支援文件會改版，最新範圍請以freee官方說明頁為準。"
          },
          {
            "question": "顧問的社會保險勞務士會從freee裡面代理申請嗎？",
            "answer": "freee官方說明頁明確寫著「目前不支援由社會保險勞務士進行的代理人申請」（2026年4月10日更新）。代理申請時，使用的是社會保險勞務士這一側的系統。您可以繼續使用freee人事労務，不需要更換軟體。"
          },
          {
            "question": "年終調整也能委託社會保險勞務士嗎？",
            "answer": "freee人事労務有年終調整功能，但收取報酬代辦屬於稅務領域，是稅理士的業務。本事務所不承接，會為您介紹稅理士，由您直接委任。不收取介紹費。"
          }
        ]
      },
      "zh": {
        ...
        "faq": [
          {
            "question": "既然freee能做到电子申请，委托社会保险劳务士还有意义吗？",
            "answer": "自家手续由自己提出的作业，软件就能完成。委托社会保险劳务士的，是「这项手续需不需要办・期限到何时・有哪些给付可用」的判断，以及只有资格者才能收取报酬代办的制作・提出代行・事务代理（社会保险劳务士法第2条第1项第1号〜第1号之3）。作业与判断是两回事。"
          },
          {
            "question": "freee的电子申请需要什么？",
            "answer": "依官方说明页（2026年8月14日参阅），需要gBizID Prime账户，且仅限法人事业所。路径分为Mynaportal与e-Gov两种。功能与支持文件会改版，最新范围请以freee官方说明页为准。"
          },
          {
            "question": "顾问的社会保险劳务士会从freee里面代理申请吗？",
            "answer": "freee官方说明页明确写着「目前不支持由社会保险劳务士进行的代理人申请」（2026年4月10日更新）。代理申请时，使用的是社会保险劳务士这一侧的系统。您可以继续使用freee人事労務，不需要更换软件。"
          },
          {
            "question": "年终调整也能委托社会保险劳务士吗？",
            "answer": "freee人事労務有年终调整功能，但收取报酬代办属于税务领域，是税理士的业务。本事务所不承接，会为您介绍税理士，由您直接委任。不收取介绍费。"
          }
        ]
      }
    }
  },
  {
    ...
    "translations": {
      "en": {
        ...
        "faq": [
          {
            "question": "Can I really bring in what the AI told me, as it is?",
            "answer": "Yes. A screenshot is fine. Add the context the question assumed (industry, headcount, employment types) and one sentence — \"can we proceed as this answer says?\" — and the check goes quickly. Consultation is free."
          },
          {
            "question": "Where do AI answers tend to go wrong?",
            "answer": "The broad shape of a system is usually about right; the drift is in details — article numbers, effective dates, whether a form exists. For example, wage claims do not prescribe \"uniformly in 3 years\": under Article 115 of the Labor Standards Act and Article 143, paragraph 3 of the Supplementary Provisions, retirement allowances prescribe in 5 years and other wages, for the time being, in 3."
          },
          {
            "question": "Does Yotsuba itself use AI?",
            "answer": "Yes — for organising materials, surfacing issues and drafting structure. Statutes, figures and forms are always checked against primary sources, and judgement on individual matters is made by the qualified representative. AI output is never passed on as an answer as it stands."
          },
          {
            "question": "If the AI's answer turns out to be right, do I still pay for the consultation?",
            "answer": "Consultation is free. If the answer is right, we tell you so and that is the end of it. If you then engage us for procedures or drafting of rules, the fees are shown in advance, following the fee schedule."
          }
        ]
      },
      "zh-tw": {
        ...
        "faq": [
          {
            "question": "用AI查到的內容，可以原樣帶來嗎？",
            "answer": "可以。截圖即可。再附上提問時的前提（行業・人數・僱用形態），以及「照這個答案進行可以嗎」一句話，確認會更快。諮詢免費。"
          },
          {
            "question": "AI的答案容易錯在哪裡？",
            "answer": "制度的骨架大多是對的，偏差出現在細節——條文號碼・施行日・格式是否存在。例如工資請求權的時效不是「一律3年」：依勞動基準法第115條與附則第143條第3項，退職金是5年，其他工資當分期間（暫時）是3年。"
          },
          {
            "question": "四葉自己也用AI嗎？",
            "answer": "用。但只到資料整理・論點盤點・架構草稿為止。條文・數字・格式必定以一次資料確認，個別案件的判斷由具備資格的代表進行。不會把AI的輸出原樣作為回答交給您。"
          },
          {
            "question": "如果AI的答案是對的，諮詢也要收費嗎？",
            "answer": "諮詢免費。答案對的話，告訴您「是對的」就結束。之後若委託手續或規程的整備，費用依報酬額表事先向您提示。"
          }
        ]
      },
      "zh": {
        ...
        "faq": [
          {
            "question": "用AI查到的内容，可以原样带来吗？",
            "answer": "可以。截图即可。再附上提问时的前提（行业・人数・雇用形态），以及「照这个答案进行可以吗」一句话，确认会更快。咨询免费。"
          },
          {
            "question": "AI的答案容易错在哪里？",
            "answer": "制度的骨架大多是对的，偏差出现在细节——条文号码・施行日・格式是否存在。例如工资请求权的时效不是「一律3年」：依劳动基准法第115条与附则第143条第3项，退职金是5年，其他工资当分期间（暂时）是3年。"
          },
          {
            "question": "四叶自己也用AI吗？",
            "answer": "用。但只到资料整理・论点盘点・架构草稿为止。条文・数字・格式必定以一次资料确认，个别案件的判断由具备资格的代表进行。不会把AI的输出原样作为回答交给您。"
          },
          {
            "question": "如果AI的答案是对的，咨询也要收费吗？",
            "answer": "咨询免费。答案对的话，告诉您「是对的」就结束。之后若委托手续或规程的整备，费用依报酬额表事先向您提示。"
          }
        ]
      }
    }
  },
  {
    ...
    "faq": [
      {
        "question": "給与計算を頼んでいる社労士に、年末調整もあわせて頼めますか？",
        "answer": "頼めません。年末調整は税務の手続で、報酬を得て代わりに行うのは税理士の業務です（税理士法第2条第1項）。当事務所でも取り扱っておらず、税理士に直接ご依頼いただく形をご案内しています。紹介料の授受はありません。"
      },
      {
        "question": "freeeのプランによって、年末調整でできることは違いますか？",
        "answer": "違います。公式ヘルプ（2026年8月14日参照）によると、年末調整ペーパーレスプランは情報収集とCSV出力まで、ミニマムプランは計算まで（電子申告不可）、スタータープラン以上で電子申告までできます。機能は改定されるため、最新は公式ヘルプでご確認ください。"
      },
      {
        "question": "自社で年末調整を完結させるのに、資格は要りますか？",
        "answer": "要りません。自社の手続を自社で行うことは、資格の線の外側です。電子申告まで行う場合は、対応プランの契約とe-Tax・eLTAXの事前準備が必要です。"
      },
      {
        "question": "「給与計算は社労士、年末調整は税理士」と分けると、二度手間になりませんか？",
        "answer": "契約は分かれますが、作業は連続しています。毎月の給与データが正確に積み上がっていれば、年末調整側の作業は軽くなります。誰が何をどこまで持つかを11月までに決めておくことが、二度手間を防ぐ実務です。"
      }
    ],
    "translations": {
      "en": {
        "title": "The year-end adjustment in freee — whose job is it?",
        "excerpt": "freee HR has a year-end adjustment feature, and no licence is needed to run it for your own company. But the year-end adjustment is a tax procedure that settles over- and under-withheld income tax, and doing it for another party for a fee is work for a tax accountant. Even if a shakai hoken roumushi runs your payroll, the year-end adjustment is not included.",
        "content": "**In short:** freee HR (freee人事労務) has a year-end adjustment feature, and **no licence is needed to run it for your own company**. But the year-end adjustment (nenmatsu chōsei) is a **tax procedure** that settles the over- and under-withholding of income tax, and doing it for another party for a fee is work for **a tax accountant**. Even if a shakai hoken roumushi runs your payroll, **the year-end adjustment is not included**.\n\n\"freee has a year-end adjustment button, but our retained shakai hoken roumushi says they can't take it on\" — every year as December approaches, companies run into this apparent contradiction. This page is for owners and back-office staff planning to run the year-end adjustment in freee HR, and explains why something \"in the software\" cannot be handed to the labour consultant. Yotsuba does not handle it either; we point clients to a tax accountant.\n\n## Is the year-end adjustment part of payroll?\n\nNo — and this is where the confusion starts.\n\nIn monthly payroll, income tax is **withheld according to the withholding tax tables**. That is part of payroll, and within what you can ask a shakai hoken roumushi to do. The year-end adjustment, by contrast, **settles the difference between the total withheld during the year and the tax actually due for that year** (Income Tax Act, Article 190). The monthly withholding is a \"provisional collection\"; the year-end adjustment is the \"once-a-year settlement\". Same tax, different character of procedure.\n\nAnd the settlement side is **a tax procedure**. That is why a payroll retainer does not automatically include the year-end adjustment.\n\n## The feature is in the software — why can't we hand it over?\n\nArticle 2, paragraph 1 of the Certified Public Tax Accountant Act defines **tax agency, preparation of tax documents, and tax consultation** as the work of a tax accountant. Calculating the year-end adjustment, and the documents it produces — the withholding certificates, the statutory report summary, the salary payment reports — belong to this territory. Doing it **for another party, for a fee**, is the tax accountant's province.\n\nIf the structure looks familiar, you are right. As with the Certified Social Insurance and Labor Consultant Act discussed in [We've brought in freee HR. So what does a retained shakai hoken roumushi actually do?](/en/labor/column/freee-jinji-roumu-sharoushi-doko-made), the definition of \"tax documents\" in item 2 of the Tax Accountant Act also expressly **includes electronic or magnetic records**. **Paper or cloud data, the line is drawn the same way.** The software's feature exists so you can do your own company's work yourself; the licensing line for having someone do it for you runs outside the screen.\n\nfreee's official help (updated 21 July 2026, viewed 14 August 2026) also divides what each plan can do.\n\n| Plan | What the year-end adjustment feature covers |\n|---|---|\n| Year-End Adjustment Paperless plan (年末調整ペーパーレスプラン) | **Collecting employee information and exporting CSV only.** It cannot calculate refunds and additional collections; the collected data is meant to be imported into payroll software or **shared with a professional** for the remaining work |\n| Minimum plan (ミニマムプラン) | The administrator enters the data; **calculation and reflection of refunds/additional collections** are covered. No electronic filing — paper submission |\n| Starter plan (スタータープラン, formerly Basic) and above | Employee self-entry, calculation, and **electronic filing** (advance setup in e-Tax and eLTAX required) |\n\nfreee's features and plan structure change. The table reflects materials published as of August 2026; check the official help pages for the current scope.\n\n## Heading into December, who decides what?\n\nStart the year-end adjustment in December and you will be late. There are three decisions.\n\n| Decision | Options |\n|---|---|\n| **Who calculates and finalises** | Complete it in-house in freee / engage a tax accountant |\n| **How the documents are submitted** | Electronic filing (plan and e-Tax/eLTAX setup permitting) / on paper |\n| **The employee-facing schedule** | When to request input (November is the benchmark), My Number administrator settings, how to collect insurance premium deduction certificates |\n\nIf you have a retained tax accountant, agree **by November** on how far you enter data in freee yourselves and where you hand over. If you have none and in-house completion looks difficult, deciding to engage a tax accountant comes first.\n\n## How far can a shakai hoken roumushi take it?\n\nAround the year-end adjustment sit tasks that can be handed to a shakai hoken roumushi. Drawing the line:\n\n| Task | Whom to engage |\n|---|---|\n| Monthly payroll and bonus calculation (including withholding) | A shakai hoken roumushi can take this |\n| Social and labour insurance procedures, the annual calculation report and annual renewal | A shakai hoken roumushi can take this |\n| The year-end adjustment's **tax calculation and finalisation** | **A tax accountant** |\n| Preparing and filing the withholding certificates, statutory report summary and salary payment reports **on your behalf** | **A tax accountant** |\n\nIn other words, \"payroll to the shakai hoken roumushi, year-end adjustment to the tax accountant\" — **separate contracts** — is the shape that follows the licensing lines. Since a year of accurate payroll data is the precondition for the year-end adjustment, keeping monthly payroll in order makes December lighter.\n\n## What can 四葉社会保険労務士事務所 do?\n\n四葉社会保険労務士事務所, in Kohinata, Bunkyo City, handles monthly payroll, social and labour insurance procedures, labour consultation, and the drafting and revision of work rules. **We do not handle the year-end adjustment; we point you to a tax accountant, whom you engage directly. No referral fees change hands.** If you use freee HR, there is no need to change software.\n\n**Consultation is free of charge.** We will start by sorting out how much you can do in-house and how to divide payroll from the year-end adjustment. Fees are in the [fee schedule](/en/labor/ryokin), and the questions we are asked most often are collected on the [FAQ page](/en/labor/faq).\n\n### Whom to consult\n\nTax — including the year-end adjustment, bookkeeping, closing and returns — is work for **a tax accountant**; registration for **a judicial scrivener**; matters in dispute for **an attorney**. Residence-status applications, subsidies and company-formation documents are handled by **四葉行政書士事務所** (a separate business from this office, engaged under a separate contract). In every case, no referral fees change hands.\n\n## Frequently asked questions\n\n**Q. Can the shakai hoken roumushi who runs our payroll also do our year-end adjustment?**\nA. No. The year-end adjustment is a tax procedure, and performing it for another party for a fee is the work of a tax accountant (Certified Public Tax Accountant Act, Article 2, paragraph 1). This office does not handle it either; we point you to a tax accountant, whom you engage directly. No referral fees change hands.\n\n**Q. Do freee's plans differ in what the year-end adjustment feature can do?**\nA. Yes. According to the official help (viewed 14 August 2026), the Year-End Adjustment Paperless plan covers information collection and CSV export only; the Minimum plan calculates but cannot file electronically; the Starter plan and above can file electronically. Features change — check the official help for the latest.\n\n**Q. Do we need any licence to complete the year-end adjustment in-house?**\nA. No. Doing your own company's procedures yourselves sits outside the licensing lines. To file electronically you need a qualifying plan and advance setup in e-Tax and eLTAX.\n\n**Q. Doesn't splitting \"payroll to the consultant, year-end adjustment to the tax accountant\" double the work?**\nA. The contracts split; the work is continuous. If monthly payroll data accumulates accurately, the year-end side becomes lighter. Deciding by November who holds what is the practical way to avoid duplication.\n\n## Sources for this article\n\n- Income Tax Act (所得税法, Act No. 33 of 1965), **Article 190** (year-end adjustment) — current text confirmed on e-Gov on 14 August 2026\n- Certified Public Tax Accountant Act (税理士法, Act No. 237 of 1951), **Article 2, paragraph 1** (the definition of tax documents in item 2 includes electronic or magnetic records) — current text confirmed on e-Gov the same day\n- The plan-by-plan scope of freee HR's year-end adjustment feature — freee Help Center, \"The flow of the year-end adjustment in freee HR\" (updated 21 July 2026, viewed 14 August 2026)\n\n**freee's features and plan structure change. Check freee's official help pages for the latest scope.** This article is based on materials published as of August 2026.\n\nThe overall line between the software and the shakai hoken roumushi is drawn in [We've brought in freee HR. So what does a retained shakai hoken roumushi actually do?](/en/labor/column/freee-jinji-roumu-sharoushi-doko-made); where freee's AI features (including AI Year-End Adjustment Assist) now stand is in [How far has the AI integration between freee HR and freee Accounting actually come?](/en/labor/column/freee-jinji-kaikei-ai); and how payroll pricing works in [How much does it cost to have a shakai hoken roumushi run payroll?](/en/labor/column/kyuyo-keisan-soba-sharoushi).\n\nThis article is general information. Judgments that fit your particular circumstances are made by a qualified professional after a meeting. Written by [Joji Uramatsu](/en/about/uramatsu) (Shakai Hoken Roumushi (Certified Social Insurance and Labor Consultant), Gyoseishoshi (Certified Administrative Procedures Legal Specialist), Registered Real Estate Transaction Specialist).",
        "category": "Who to ask",
        "keywords": [
          "freee year-end adjustment who to ask",
          "year-end adjustment labour consultant cannot",
          "year-end adjustment tax accountant work",
          "freee year-end adjustment plan differences",
          "payroll outsourcing year-end adjustment not included",
          "electronic filing year-end adjustment freee"
        ],
        "tags": [
          "freee",
          "year-end adjustment",
        ...
        "faq": [
          {
            "question": "Can the shakai hoken roumushi who runs our payroll also do our year-end adjustment?",
            "answer": "No. The year-end adjustment is a tax procedure, and performing it for another party for a fee is the work of a tax accountant (Certified Public Tax Accountant Act, Article 2, paragraph 1). This office does not handle it either; we point you to a tax accountant, whom you engage directly. No referral fees change hands."
          },
          {
            "question": "Do freee's plans differ in what the year-end adjustment feature can do?",
            "answer": "Yes. According to the official help (viewed 14 August 2026), the Year-End Adjustment Paperless plan covers information collection and CSV export only; the Minimum plan calculates but cannot file electronically; the Starter plan and above can file electronically. Features change — check the official help for the latest."
          },
          {
            "question": "Do we need any licence to complete the year-end adjustment in-house?",
            "answer": "No. Doing your own company's procedures yourselves sits outside the licensing lines. To file electronically you need a qualifying plan and advance setup in e-Tax and eLTAX."
          },
          {
            "question": "Doesn't splitting \"payroll to the consultant, year-end adjustment to the tax accountant\" double the work?",
            "answer": "The contracts split; the work is continuous. If monthly payroll data accumulates accurately, the year-end side becomes lighter. Deciding by November who holds what is the practical way to avoid duplication."
          }
        ]
      },
      "zh-tw": {
        ...
        "faq": [
          {
            "question": "能請負責薪資計算的社會保險勞務士順便做年終調整嗎？",
            "answer": "不能。年終調整是稅務手續，收取報酬代辦是稅理士的業務（稅理士法第2條第1項）。本事務所也不承接，會為您介紹稅理士，由您直接委任。不收取介紹費。"
          },
          {
            "question": "freee的方案不同，年終調整能做的事也不同嗎？",
            "answer": "不同。依官方說明頁（2026年8月14日參閱），年末調整ペーパーレスプラン只到資訊收集與CSV匯出，ミニマムプラン可計算但無法電子申告，スタータープラン以上可電子申告。功能會改版，最新請以官方說明頁為準。"
          },
          {
            "question": "自家公司完成年終調整，需要資格嗎？",
            "answer": "不需要。自家公司為自己辦理手續，在資格分界線之外。若要電子申告，需要對應方案的契約與e-Tax・eLTAX的事前準備。"
          },
          {
            "question": "「薪資計算找社勞士、年終調整找稅理士」分開委託，不會變成雙重作業嗎？",
            "answer": "契約分開，但作業是連續的。每月薪資資料正確累積，年終調整這一側的作業就會變輕。在11月之前決定誰負責到哪裡，是避免重複作業的實務做法。"
          }
        ]
      },
      "zh": {
        ...
        "faq": [
          {
            "question": "能请负责工资计算的社会保险劳务士顺便做年终调整吗？",
            "answer": "不能。年终调整是税务手续，收取报酬代办是税理士的业务（税理士法第2条第1项）。本事务所也不承接，会为您介绍税理士，由您直接委任。不收取介绍费。"
          },
          {
            "question": "freee的方案不同，年终调整能做的事也不同吗？",
            "answer": "不同。依官方说明页（2026年8月14日参阅），年末調整ペーパーレスプラン只到信息收集与CSV导出，ミニマムプラン可计算但无法电子申告，スタータープラン以上可电子申告。功能会改版，最新请以官方说明页为准。"
          },
          {
            "question": "自家公司完成年终调整，需要资格吗？",
            "answer": "不需要。自家公司为自己办理手续，在资格分界线之外。若要电子申告，需要对应方案的契约与e-Tax・eLTAX的事前准备。"
          },
          {
            "question": "「工资计算找社劳士、年终调整找税理士」分开委托，不会变成双重作业吗？",
            "answer": "契约分开，但作业是连续的。每月工资数据正确累积，年终调整这一侧的作业就会变轻。在11月之前决定谁负责到哪里，是避免重复作业的实务做法。"
          }
        ]
      }
    }
  },
  {
    ...
    "translations": {
      "en": {
        ...
        "faq": [
          {
            "question": "Can we file AI-drafted work rules with the Labour Standards Inspection Office as they are?",
            "answer": "Formally, yes. There is no prescribed format and no qualification requirement for the drafter. But a document recording the opinion of the majority representative must be attached (Labor Standards Act, Article 90), and making the rules known to workers is an obligation (Article 106). Acceptance of the filing is no guarantee that the rules will function effectively."
          },
          {
            "question": "Is filing required with fewer than ten employees?",
            "answer": "The obligation to draw up and file applies to workplaces with ten or more workers regularly employed (Labor Standards Act, Article 89). Below ten there is no obligation, though having rules to anchor working conditions still has value. See From how many workers are work rules mandatory — and what is not mandatory?."
          },
          {
            "question": "What do you most often end up fixing in AI drafts?",
            "answer": "As a general tendency: provisions on working hours and allowances that do not match reality, amendments not reflected, and clauses left in for schemes the company does not have. It is the matching against reality, not the prose, that takes the time."
          },
          {
            "question": "Is it cheaper if we bring our own draft?",
            "answer": "It depends. The main body of the work is the fact-finding and the matching against reality, so the existence of a draft does not always change the workload much. Either way, we present an estimate in advance, following the fee schedule. Consultation is free."
          }
        ]
      },
      "zh-tw": {
        ...
        "faq": [
          {
            "question": "AI寫的就業規則，能直接提交給勞動基準監督署嗎？",
            "answer": "形式上能。沒有格式的指定，也不問製作者的資格。但需要附上聽取過半數代表等意見的書面（勞動基準法第90條），向勞工周知也是義務（第106條）。被受理，不是規程有效發揮作用的保證。"
          },
          {
            "question": "員工不到10人，也需要申報嗎？",
            "answer": "製作・申報的義務適用於「經常僱用10人以上」的事業場（勞動基準法第89條）。不到10人沒有義務，但為了明確勞動條件的依據，製作仍有意義。詳見就業規則從幾人開始是義務。哪些不是義務。"
          },
          {
            "question": "AI的草案，最常修改的是哪裡？",
            "answer": "就一般傾向而言：工時制度或津貼的規定與實態不符的地方、未反映修法的地方、這家公司沒有的制度規定殘留的地方。花時間的不是文章的好壞，而是與實態的核對。"
          },
          {
            "question": "帶草案來，費用會比較便宜嗎？",
            "answer": "視內容而定。作業的本體是實態的聽取與核對，有無草案未必大幅改變作業量。無論哪種情形，著手前都會依報酬額表提示估價。諮詢免費。"
          }
        ]
      },
      "zh": {
        ...
        "faq": [
          {
            "question": "AI写的就业规则，能直接提交给劳动基准监督署吗？",
            "answer": "形式上能。没有格式的指定，也不问制作者的资格。但需要附上听取过半数代表等意见的书面（劳动基准法第90条），向劳动者周知也是义务（第106条）。被受理，不是规程有效发挥作用的保证。"
          },
          {
            "question": "员工不到10人，也需要申报吗？",
            "answer": "制作・申报的义务适用于「经常雇用10人以上」的事业场（劳动基准法第89条）。不到10人没有义务，但为了明确劳动条件的依据，制作仍有意义。详见就业规则从几人开始是义务。哪些不是义务。"
          },
          {
            "question": "AI的草案，最常修改的是哪里？",
            "answer": "就一般倾向而言：工时制度或津贴的规定与实态不符的地方、未反映修法的地方、这家公司没有的制度规定残留的地方。花时间的不是文章的好坏，而是与实态的核对。"
          },
          {
            "question": "带草案来，费用会比较便宜吗？",
            "answer": "视内容而定。作业的本体是实态的听取与核对，有无草案未必大幅改变作业量。无论哪种情形，着手前都会依报酬额表提示估价。咨询免费。"
          }
        ]
      }
    }
  },
  {
    ...
    "faq": [
      {
        "question": "従業員の名前や給与額をAIに入れるのは、違法なのですか？",
        "answer": "一律には決まりません。個人情報保護委員会は、本人の同意なく個人データを含むプロンプトを入力し、それが応答の出力以外の目的で取り扱われる場合、個人情報保護法に違反する可能性があると指摘しています（令和5年6月2日注意喚起）。サービスの契約・設定で扱いが変わるため、線引きを決めてから使うことをお勧めします。個別の適法性の判断が必要な場合は、弁護士にご相談ください。"
      },
      {
        "question": "「学習しない」設定にすれば、従業員の情報を入れてもよいですか？",
        "answer": "設定の確認は出発点として重要ですが、それだけで「入れてよい」ことにはなりません。学習に使わない設定でも入力データが一定期間保存される場合があり、安全管理措置（個人情報保護法第23条）や利用目的の範囲の論点も残ります。当事務所は、設定にかかわらず顧客・従業員の個人データを生成AIに入力しない運用にしています。"
      },
      {
        "question": "社会保険労務士に給与データを渡すのは、大丈夫なのですか？",
        "answer": "開業社会保険労務士と、社会保険労務士でつくる法人の社員には法律上の守秘義務があり、その立場でなくなった後も続きます（社会保険労務士法第21条）。また会社から見ると、事務所は個人データの取扱いの委託先で、会社には委託先を監督する立場があります（個人情報保護法第25条）。取扱いの運用を事務所に確認することは、頼む側の当然の権利です。"
      },
      {
        "question": "社内のAI利用ルールづくりは、どこに相談すればよいですか？",
        "answer": "服務規律として就業規則に位置づける部分は、社会保険労務士がお受けできます。個人情報保護法の解釈が必要な部分は弁護士に、制度の一次情報は個人情報保護委員会の公表資料をご確認ください。当事務所のご相談は無料です。"
      }
    ],
    "translations": {
      "en": {
        ...
        "faq": [
          {
            "question": "Is it illegal to put employees' names or salaries into an AI?",
            "answer": "There is no blanket answer. The Personal Information Protection Commission has said that entering personal data into a prompt without the person's consent, where it is handled for purposes other than producing the response, may violate the Act (alert of 2 June 2023). Since the treatment turns on each service's contract and settings, we recommend deciding the lines before use. Where a judgement of lawfulness is needed, consult an attorney."
          },
          {
            "question": "If we turn on the \"no-training\" setting, may employee information go in?",
            "answer": "Checking the setting is an important starting point, but it does not by itself make the data acceptable to enter. Even with training off, input may be retained for a period, and the questions of security control measures (Article 23) and the scope of the purpose of use remain. This office does not enter client or employee personal data into generative AI, whatever the settings."
          },
          {
            "question": "Is it safe to hand payroll data to a shakai hoken roumushi?",
            "answer": "A practising shakai hoken roumushi, and the members of a corporation formed by shakai hoken roumushi, are under a statutory duty of confidentiality that continues after they leave the position (Certified Social Insurance and Labor Consultant Act, Article 21). And from the company's side, the office is a contractor whose data handling the company is charged with supervising (Act on the Protection of Personal Information, Article 25). Asking an office how it handles data is the client's proper role."
          },
          {
            "question": "Where do we take the drafting of internal AI-use rules?",
            "answer": "The part framed as service discipline within the work rules can be taken on by a shakai hoken roumushi. Parts requiring interpretation of the Act on the Protection of Personal Information go to an attorney, and for primary sources see the Personal Information Protection Commission's published materials. Consultation with this office is free."
          }
        ]
      },
      "zh-tw": {
        ...
        "faq": [
          {
            "question": "把員工的姓名或工資輸入AI，是違法的嗎？",
            "answer": "沒有一律的答案。個人情報保護委員会指出，未經本人同意輸入含個人資料的提示詞，且該資料在產生回應以外的目的下被處理時，有違反個人情報保護法的可能（令和5年6月2日注意提醒）。因服務的契約・設定而處理方式不同，建議先劃好界線再使用。需要判斷個別適法性時，請諮詢律師。"
          },
          {
            "question": "設成「不用於學習」，就可以輸入員工資訊了嗎？",
            "answer": "確認設定是重要的出發點，但僅此並不等於「可以輸入」。即使不用於學習，輸入資料仍可能被保存一段期間，安全管理措施（個人情報保護法第23條）與利用目的範圍的論點也仍然存在。本事務所無論設定如何，都不將顧客・員工的個人資料輸入生成式AI。"
          },
          {
            "question": "把工資資料交給社會保險勞務士，沒問題嗎？",
            "answer": "開業的社會保險勞務士，以及由社會保險勞務士組成的法人（社会保険労務士法人）的社員，負有法律上的守密義務，離開該身分後仍持續（社會保險勞務士法第21條）。而且從公司的角度看，事務所是個人資料處理的受託方，公司負有監督的立場（個人情報保護法第25條）。向事務所確認資料的處理方式，是委託方理所當然的權利。"
          },
          {
            "question": "公司的AI使用規則，該找誰商量？",
            "answer": "作為服務紀律納入就業規則的部分，社會保險勞務士可以承接。需要解釋個人情報保護法的部分請諮詢律師，制度的一次資訊請確認個人情報保護委員会的公開資料。本事務所的諮詢免費。"
          }
        ]
      },
      "zh": {
        ...
        "faq": [
          {
            "question": "把员工的姓名或工资输入AI，是违法的吗？",
            "answer": "没有一律的答案。個人情報保護委員会指出，未经本人同意输入含个人数据的提示词，且该数据在产生回应以外的目的下被处理时，有违反个人情报保护法的可能（令和5年6月2日注意提醒）。因服务的契约・设置而处理方式不同，建议先划好界线再使用。需要判断个别适法性时，请咨询律师。"
          },
          {
            "question": "设成「不用于学习」，就可以输入员工信息了吗？",
            "answer": "确认设置是重要的出发点，但仅此并不等于「可以输入」。即使不用于学习，输入数据仍可能被保存一段期间，安全管理措施（个人情报保护法第23条）与利用目的范围的论点也仍然存在。本事务所无论设置如何，都不将顾客・员工的个人数据输入生成式AI。"
          },
          {
            "question": "把工资数据交给社会保险劳务士，没问题吗？",
            "answer": "开业的社会保险劳务士，以及由社会保险劳务士组成的法人（社会保険労務士法人）的社员，负有法律上的保密义务，离开该身份后仍持续（社会保险劳务士法第21条）。而且从公司的角度看，事务所是个人数据处理的受托方，公司负有监督的立场（个人情报保护法第25条）。向事务所确认数据的处理方式，是委托方理所当然的权利。"
          },
          {
            "question": "公司的AI使用规则，该找谁商量？",
            "answer": "作为服务纪律纳入就业规则的部分，社会保险劳务士可以承接。需要解释个人情报保护法的部分请咨询律师，制度的一次信息请确认個人情報保護委員会的公开资料。本事务所的咨询免费。"
          }
        ]
      }
    }
