...
const ja = {
  propertyName: "お問い合わせ物件名・号室", propertyHint: "選んだ物件名を入力済みです。必要に応じて号室などを追記・修正してください。", propertyLink: "選んだ物件を確認する",
...
export const propertyViewingLabels = {
  ja,
  en: {
    propertyName: "Property name and unit number", propertyHint: "The selected property is prefilled. You can add or correct the unit number or property name.", propertyLink: "View the selected property",
  ...
  "zh-tw": {
    propertyName: "詢問物件名稱・房號", propertyHint: "已填入您選擇的物件名稱，可依需要補充或修改房號及物件名稱。", propertyLink: "查看所選物件",
  ...
  zh: {
    propertyName: "咨询房源名称・房号", propertyHint: "已填入您选择的房源名称，可按需补充或修改房号及房源名称。", propertyLink: "查看所选房源",
