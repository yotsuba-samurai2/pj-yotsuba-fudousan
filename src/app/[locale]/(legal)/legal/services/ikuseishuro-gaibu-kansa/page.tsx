...
// 【代表の講習修了の裏取り（2026-08-06・Gmailの一次記録）】
//   ・実施団体＝公益社団法人全国労働基準関係団体連合会（全基連）／講習名＝監理責任者等講習
//     （外国人技能実習制度関係者養成講習）／受講日＝2026年7月10日（オンライン・受講番号9）
//   ・証跡＝申込受付(2026-05-22)／請求書・受講料振込(2026-05-25)／本人確認書類(2026-06-19)／
//     受講票(2026-06-26)／招待メール(2026-07-07)／受講当日の理解度テスト案内(2026-07-10)
//   ・3年以内要件（施行規則第47条第2項第1号）＝2029年7月10日まで。施行日2027年4月1日時点で充足
//   ・修了証＝郵送で交付され、2026-08-06に浦松が受領を確認済み（メールに交付記録が無かったのは
//     郵送のため。当初「未検証」としていたが解消した）
...
const JA_WHEN: { item: string; state: string }[] = [
  { item: "制度の施行", state: "2027年（令和9年）4月1日。現時点では施行前です" },
  {
    item: "監理支援機関の許可申請",
    state:
      "施行日前申請の受付が始まっています。申請書類一式・様式が外国人技能実習機構のサイトで公開され、専用のコールセンター（0570-011-300・平日9:00〜17:00）も開設されています（2026年8月14日確認）",
  },
  {
    item: "育成就労計画認定の申請",
    state:
      "施行日前申請が2026年9月1日から始まります（9月1日以降に到着するように送付。提出先は本部ではなく地方事務所・支所。外国人技能実習機構の案内による）",
  },
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="mt-4 leading-relaxed text-text">
          制度は<strong className="text-ink">まだ施行されていません</strong>が、許可申請の受付は始まっています。そして、外国人技能実習機構が公開している申請書類の一覧には、<strong className="text-ink">外部監査人の就任承諾書及び誓約書並びに概要書（参考様式第2-5号）が含まれています</strong>（2026年8月14日確認）。つまり、<strong className="text-ink">申請書を出す時点で、外部監査人が決まっている必要があります</strong>。「許可が下りてから監査人を探す」という順序では申請できないため、監理支援機関の許可をお考えの場合は、監査人の確保を申請準備の最初に置いてください。
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mt-3 leading-relaxed text-text">
          ...
          <strong className="text-ink">2026年7月に公益社団法人全国労働基準関係団体連合会の監理責任者等講習を修了しています</strong>。育成就労法施行規則の附則は、当分の間、この講習の修了者を外部監査人の講習要件（施行規則第47条第2項第1号）を満たす者として扱うと定めています。元毎日新聞記者・中国総局長として中国や台湾、タイに駐在した経歴があり、送出国側の事情もふまえた確認ができます。
        </p>
        <p className="mt-3 leading-relaxed text-text">
