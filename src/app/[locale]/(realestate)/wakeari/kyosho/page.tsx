      ...
      >
        ...
        <div>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 leading-relaxed text-text">
            ...
            <li>
              <strong className="text-ink">② 狭小住宅の用地として売る。</strong>建築の制限を確認したうえで、建てられる規模を添えて買い手を探します。買取をご希望なら、提携する買取業者に打診して提示を並べます。
            </li>
            <li>
        ...
        <div>
          ...
          <ol className="mt-3 list-decimal space-y-2 pl-5 leading-relaxed text-text">
            ...
            <li>媒介契約は書面で、価額の根拠と報酬（宅地建物取引業法第46条の上限の範囲内）を明示し、買い手の候補ごとに打診します。買取をご希望なら提携する買取業者に打診して提示を並べます。</li>
