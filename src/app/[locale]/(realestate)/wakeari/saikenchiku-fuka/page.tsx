    ...
    <>
      ...
      >
        ...
        <div>
          ...
          <p className="mt-3 leading-relaxed text-text">
            買取をご希望の場合、買主は提携する買取業者です。当社は売主様との媒介契約に基づいて複数の買取業者に打診し、提示を並べます。買主が誰かは書面で明示します（宅地建物取引業法第34条の取引態様の明示）。
          </p>
        </div>
        ...
        <div>
          ...
          <ol className="mt-3 list-decimal space-y-2 pl-5 leading-relaxed text-text">
            ...
            <li>媒介契約は書面で、価額の根拠と報酬（宅地建物取引業法第46条の上限の範囲内）を明示します。買い手の候補ごとに打診し、買取をご希望なら提携する買取業者に打診して提示を並べます。</li>
