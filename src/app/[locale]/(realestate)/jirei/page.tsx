...
const JA_ANSWER_BLOCK =
  "本ページは、四葉不動産株式会社に寄せられることが想定されるご相談を、モデルケース（想定される相談の流れ）としてまとめたものです。グループホーム開設、中国語での相続不動産の売却、文京区の空き家の出口整理、海外在住オーナーの遠隔売却、再建築不可の旗竿地を貸して持つ、の5つについて、四葉不動産株式会社の担当範囲と、併設の四葉行政書士事務所が別契約で受任する範囲、他の専門家との連携を示します。実在のお客様・取引を紹介するものではありません。";
...
// ItemList JSON-LD＝事例の一覧（2026-09-24 に⑤を追加して5事例）。BreadcrumbList は <Breadcrumb> 部品が出力するためここでは出さない。
...
export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata({
    ...
    description:
      "四葉不動産株式会社に寄せられることが想定されるご相談を、モデルケース（想定される相談の流れ）としてご紹介します。グループホーム開設、中国語での相続不動産の売却、文京区の空き家の出口整理、海外在住オーナーの遠隔売却、再建築不可の旗竿地を貸して持つの5例。実在のお客様・取引を紹介するものではありません。書類作成など法務手続きは併設の四葉行政書士事務所が別契約で受任します。",
    path: PATH,
    keywords: [
      "文京区 不動産 相談事例",
      "グループホーム 開設 物件",
