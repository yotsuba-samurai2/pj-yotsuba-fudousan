...
// ①〜④の本文＝2026-07-19浦松検収済み草稿（各400〜600字）。⑤は2026-09-24追加（再検収前）、⑥は2026-09-24追加・同日浦松検収済み。
...
const CASES: ModelCase[] = [
  ...
  // 2026-09-24 追加（企画書 v1.0 §3-4 の「共有×相続」。決定6＝モデルケース化は 2026-09-24 浦松了承）。本番公開後の 2026-09-24 に浦松検収済み（文言の修正なし）。
