import { PropertySearchSampleSection } from "@/components/shared/PropertySearchSample";
...
const ANSWER_BLOCK =
  "事業用・福祉施設の物件探しは、ご希望の整理から候補の比較、用途・設備の確認、内見、申込みへと進めます。このページでは9ページの資料サンプルとあわせてご案内しています。売却・貸主向けの流れもご覧いただけます。ご相談は無料です（初回・2回目以降とも）。売却の査定も無料で、査定を見てからご依頼をお決めいただけます。売却は、買主を探す「仲介」と、当社が直接買い取る「買取」で流れが変わります。仲介はご相談から引渡しまでおおむね3〜6か月、買取は買主を探す期間がない分だけ短くなります。仲介手数料をお支払いいただくのは売買契約と引渡しの時で、ご相談や査定の段階では費用はかかりません。登記は司法書士、税務の申告は税理士の業務のため、おつなぎしたうえでご本人と直接ご契約いただきます。当社が紹介料を受け取ることはありません。";
...
export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata({
    ...
    title: "物件探し・売却・賃貸の流れ｜資料サンプル付き",
    description:
      "事業用・福祉施設の物件探しから、売却・賃貸までの流れをご紹介。候補一覧と詳細をまとめた9ページの架空サンプルPDFもご覧いただけます。ご相談も査定も無料です。売却（仲介）は6段階、賃貸は4段階。ご用意いただく書類と、費用をいつお支払いいただくかも一覧にしています。登記は司法書士、税務は税理士の業務のため、おつなぎしたうえでご本人と直接ご契約いただきます。文京区小日向・茗荷谷駅から徒歩5分。",
    path: "/nagare",
    keywords: [
      "不動産 売却 流れ",
      "不動産 売却 必要書類",
