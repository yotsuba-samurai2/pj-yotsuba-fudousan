...
const JA_ANSWER_BLOCK =
  "海外転勤や海外移住が決まり、持ち家を賃貸に出すか空けておくかを決めるとき、順番に決めることは4つです。①貸すのか空けておくのか ②普通借家か定期借家か（帰任して自分が住む予定があるなら定期借家を検討します） ③誰が日本側の窓口になるのか ④納税管理人を誰にするのか。納税管理人は出国の時までに税務署へ届け出ます。届け出ずに出国すると、その年の確定申告と納税を出国の時までに済ませることになります。非居住者が日本国内の不動産を貸すと、借主が法人の場合などは家賃から20.42%が源泉徴収されます。四葉不動産株式会社（文京区小日向・茗荷谷駅徒歩5分）は①②③を宅地建物取引業として、④の納税管理人・届出書の作成・確定申告は税理士におつなぎします（ご本人と直接ご契約いただきます）。契約はそれぞれ直接結んでいただきます。";
...
const JA_NOUZEI: { option: string; when: string; point: string }[] = [
  ...
  },
  {
    ...
    point:
      "賃貸募集・管理は四葉不動産株式会社が。納税管理人・届出・申告は税理士におつなぎし、ご本人と直接ご契約いただきます。紹介料のやりとりはありません。",
  },
];
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="mt-3 leading-relaxed text-text">
          個別の契約でどちらが妥当か、期間を何年にするかは、物件の条件と赴任期間によって変わります。<strong className="text-ink">契約書の条項の適法性や、借主との紛争になったときの見通しは弁護士の領域です。</strong>当社は宅地建物取引業として募集・契約・管理をお受けし、納税管理人・税務の届出と申告は税理士におつなぎし、ご本人と直接ご契約いただきます。紹介料のやりとりはありません。
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mt-3 leading-relaxed text-text">
          <strong className="text-ink">売却の場合は登記が伴うため、印鑑証明書に代わる在外公館の署名証明などが必要になります。</strong>登記手続きそのものは司法書士の業務ですので、司法書士へおつなぎします（ご本人と直接ご契約いただきます）。※必要書類は国・地域と管轄法務局によって異なるため、個別に確認します。
        </p>
        <p className="mt-3 leading-relaxed text-text">
          帰国してご自分で住む予定がある場合は
      ...
      <div>
        ...
        <ul className="mt-4 list-disc space-y-2 pl-5 leading-relaxed text-text">
          ...
          <li>
            <strong className="text-ink">税務は税理士、登記は司法書士におつなぎし、それぞれご本人と直接ご契約いただきます。</strong>四葉が間に立って報酬を受け取ることはありません
          </li>
        </ul>
      </div>
