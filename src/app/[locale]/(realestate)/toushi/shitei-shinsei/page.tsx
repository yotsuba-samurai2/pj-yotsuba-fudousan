...
//   独占業務の表現＝「作成」が行政書士の独占業務（行政書士法1条の3・19条1項）。「作成・提出は独占業務」と
...
export default async function Page() {
  return (
    ...
    >
      <PropertySearchSampleTeaser page="/toushi/shitei-shinsei" />
      ...
      <div>
        ...
        <p className="mt-3 leading-relaxed text-text">
          行政書士法第1条の3第1項は、他人の依頼を受け、報酬を得て、官公署に提出する書類を作成することを行政書士の業務と定めています。障害福祉サービスの指定申請書類は、都道府県などの指定権者（官公署）に提出する書類にあたるため、その作成を業務として引き受けられるのは、原則として行政書士に限られます。あわせて同法第19条第1項は、行政書士でない者が、業としてこれらの書類を作成することを、法律に別段の定めがある場合を除いて禁じています。
        </p>
        <p className="mt-3 leading-relaxed text-text">
        ...
        <p className="mt-3 text-xs text-text-muted">
          ※令和8年（2026年）1月1日施行の改正（令和7年法律第65号）で第1条の2（職責）が新設され、条番号が繰り下がりました。改正前の「第1条の2＝業務」は、現行では第1条の3にあたります（e-Gov法令検索で2026年8月5日に確認）。
        </p>
      </div>
