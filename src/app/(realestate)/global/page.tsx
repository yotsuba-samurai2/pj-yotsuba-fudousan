...
const COPY: Record<LangCode, GlobalCopy> = {
  ja: {
    ...
    metaDesc:
      "日本での家探しを、四葉不動産株式会社が母語でサポートします。入居審査・契約・暮らしの手続きまで、日本語・英語・中国語（繁体字・簡体字）で対応。元毎日新聞中国総局長で海外4カ国の在住経験を持つ代表が、言葉と制度の両面から外国人のお部屋探しを支えます。",
    crumbHome: "ホーム",
    ...
    lead: (
      <p>
        外国人の方の日本での家探しは、<strong>四葉不動産株式会社が母語でサポートします</strong>。対応言語は日本語・英語・中国語（繁体字・簡体字）。入居審査・保証会社・契約・入居後の手続きまで、一つずつ一緒に進めます。代表の浦松 丈二は元毎日新聞中国総局長として海外4カ国に住み、「外国で家を探す側」の経験があります。だから、何が不安かがわかります。
      </p>
    ),
    internalLinks: [
