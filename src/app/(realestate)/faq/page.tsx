...
const COPY: Record<LangCode, FaqPageCopy> = {
  ...
  "zh-tw": {
    ...
    items: [
      ...
      {
        q: "可以用中文或英文諮詢嗎？",
        a: "可以。代表・浦松丈二曾任每日新聞中國總局長，曾派駐中國、台灣、泰國，可用日文、英文、中文（繁體・簡體）對應。外國人士找房，也請參閱「外國人・多語言找房服務」頁面。",
      },
      {
        q: "文京區以外的物件也可以諮詢嗎？",
  ...
  zh: {
    ...
    items: [
      ...
      {
        q: "可以用中文或英文咨询吗？",
        a: "可以。代表・浦松丈二曾任每日新闻中国总局长，曾派驻中国、台湾、泰国，可用日语、英语、中文（繁体・简体）对应。外国人士找房，也请参阅「外国人・多语言找房服务」页面。",
      },
      {
        q: "文京区以外的物件也可以咨询吗？",
