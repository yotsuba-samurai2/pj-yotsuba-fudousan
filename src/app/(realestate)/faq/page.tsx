...
const COPY: Record<LangCode, FaqPageCopy> = {
  ja: {
    ...
    items: [
      {
        q: "相続や不動産の相談は無料ですか？",
        a: "初回のご相談は無料です。2回目以降で、媒介を伴わない不動産コンサルティング（セカンドオピニオン、資産全体の活用・保有方針の助言など＝媒介以外の関連業務）は、事前のご同意のうえ原則30分5,500円（税込・オンライン可）で承ります。売買・賃貸の媒介に関するご相談は、仲介手数料の範囲で承ります。まずはLINEか電話で一言からで大丈夫です。",
      },
      {
        q: "中国語・英語でも相談できますか？",
        a: "できます。代表の浦松丈二は元毎日新聞中国総局長として中国や台湾、タイに駐在した経験があり、日本語・英語・中国語（繁体字・簡体字）で対応します。外国人の方のお部屋探しは「外国人・多言語のお部屋探し」ページもご覧ください。",
      },
      {
        q: "文京区以外の物件でも相談できますか？",
