...
const JA_DIFFS: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "日本の国際私法である「法の適用に関する通則法」（平成18年法律第78号・平成19年1月1日施行）は、第36条で「相続は、被相続人の本国法による」と定めています。ただしこれは一般的な枠組みの紹介であり、実際にどの国・地域の法律で整理するかは事案ごとの検討が必要です。この判断は個別の事案によるため、必要に応じて提携弁護士と連携して進めます。",
  },
  {
...
const JA_ROLES: { work: string; who: string; contract: string }[] = [
  ...
  { work: "相続登記", who: "提携司法書士をご紹介", contract: "直接契約" },
  { work: "相続税の申告", who: "提携税理士をご紹介", contract: "直接契約" },
];
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildPageMetadata({
    ...
    description:
      "在日中国人の方の相続、中国大陸・台湾・香港に相続人がいる相続——日本の不動産相続を中国語（繁体字・簡体字）で相談できます。戸籍・公証書類の収集の整理や、遺産分割協議書など官公署に提出する書類の作成は併設の四葉行政書士事務所が別契約で受任。不動産の管理・活用・売却は四葉不動産株式会社が担当します。準拠法など法的判断は提携弁護士と連携。東京都文京区小日向・茗荷谷駅徒歩5分。",
