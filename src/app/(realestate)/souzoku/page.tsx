...
const META: Record<LangCode, { title: string; description: string }> = {
  ...
  en: {
    ...
    description:
      "When you inherit real estate in Bunkyo, Tokyo, there are three exits: manage, utilize, or sell. From preparing for the mandatory inheritance registration (in force April 2024; within three years in principle, and by March 31, 2027 for past inheritances) to choosing your exit, Yotsuba Real Estate in Kohinata, Bunkyo walks with you one-stop in coordination with partner professionals.",
  },
  "zh-tw": {
    title: "在文京區繼承不動產｜管理・活用・出售完全指南",
    description:
      "在文京區繼承不動產後，出口有管理・活用・出售3種。從因應繼承登記的義務化（2024年4月施行・原則3年以內，過去部分至2027年3月31日），到出口的選法，文京區小日向的四葉不動産與合作的專業人士聯手，一站式陪伴您。",
  },
  zh: {
    title: "在文京区继承不动产｜管理・活用・出售完全指南",
    description:
      "在文京区继承不动产后，出口有管理・活用・出售3种。从应对继承登记的义务化（2024年4月施行・原则3年以内，过去部分至2027年3月31日），到出口的选法，文京区小日向的四葉不動産与合作的专业人士协作，一站式陪伴您。",
  },
};
