...
const COPY: Record<LangCode, SouzokuNagareCopy> = {
  ...
  zh: {
    ...
    expertsBody: (
      <>
        四葉不動産株式会社经营不动产的咨询・买卖・租赁・管理。<strong>继承登记属司法书士、遗产税属税理士</strong>的领域，这些将与合作的专家协同推进。继承相关的文件制作・许认可，可由关联事业四葉行政書士事務所（不同事业体）对应。
      </>
    ),
    guideLinkLabel: "在文京区继承了不动产之后——完全指南",
    inheritanceLinkLabel: "继承・遗嘱的手续（四葉行政書士事務所）",
    independenceNote:
      "※四葉不動産株式会社与四葉行政書士事務所为不同事业体，各自独立受理委托（不收受介绍费等）。",
    relatedAria: "相关链接",
