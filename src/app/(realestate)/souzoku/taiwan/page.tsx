...
const JA_ROLES: { work: string; license: string; who: string }[] = [
  ...
  { work: "準拠法の判断・紛争性のある事案", license: "——（当社では取り扱いません）", who: "提携弁護士をご紹介" },
  { work: "相続登記", license: "——（当社では取り扱いません）", who: "提携司法書士をご紹介" },
  { work: "税務（非居住者の源泉・申告等）", license: "——（当社では取り扱いません）", who: "提携税理士をご紹介" },
];
