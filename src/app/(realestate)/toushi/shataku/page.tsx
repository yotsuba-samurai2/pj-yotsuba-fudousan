...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildPageMetadata({
    ...
    description:
      "法人向けの社宅・法人契約の賃貸を、四葉不動産株式会社がサポートします。外国人従業員の住居手配は日本語・英語・中国語で対応。従業員の受け入れに必要な在留資格の手続きとあわせて、住まいの確保を一つの窓口で相談できます。",
    path: "/toushi/shataku",
...
export default function Page() {
  return (
    <RealestateServicePage
      ...
      lead={
        <p>
          四葉不動産株式会社は、<strong>法人向けの社宅・法人契約の賃貸</strong>をサポートします。特長は、<strong>外国人従業員の住居手配を日本語・英語・中国語で</strong>支援できること。入居審査・保証・生活ルールの説明など、外国人の入居でつまずきやすい点を、言葉の壁ごと引き受けます。
        </p>
      }
      internalLinks={[
