...
> 東京都文京区にある不動産会社。元新聞記者として4カ国で取材経験を積んだ代表・浦松丈二が行政書士資格を取得し、賃貸・売買・管理から相続不動産、外国人向け住居サポートまでを多言語（日本語・英語・中国語繁体字・中国語簡体字）でワンストップ対応する。
...
- 多言語対応（日本語・英語・中国語繁体字・中国語簡体字）により、外国籍の入居者・オーナーにも同一品質のサービスを提供
