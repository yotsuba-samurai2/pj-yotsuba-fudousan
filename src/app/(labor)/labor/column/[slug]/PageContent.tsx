      ...
      <section className="py-10 sm:py-16 md:py-24">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-4 border-t border-border pt-8 sm:grid-cols-2">
            {prev ? (
              <Link href={`/labor/column/${prev.slug}`} className="group rounded-lg border border-border bg-surface p-4 transition-all hover:border-primary/30 hover:shadow-md">
            ...
            {next ? (
              <Link href={`/labor/column/${next.slug}`} className="group rounded-lg border border-border bg-surface p-4 text-right transition-all hover:border-primary/30 hover:shadow-md">
