        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 flex items-center gap-4 border-b border-border pb-8">
            <div className="h-12 w-12 shrink-0 overflow-hidden rounded-full">
              <Image
                src="/uramatsu.png"
                alt={col.author?.name || t("labor.columnDetail.authorName")}
                width={48}
                height={48}
            ...
            <div>
              <p className="text-sm font-bold">
                {col.author?.name || t("labor.columnDetail.authorName")}
              </p>
              <p className="text-xs text-text-muted">
                {col.author?.title || t("labor.columnDetail.authorTitle")}
              </p>
            </div>
          </div>
