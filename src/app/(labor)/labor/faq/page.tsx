...
const ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "人員配置基準を踏まえた就業規則・シフト設計、社会保険手続き、処遇改善加算の要件整備まで、四葉社会保険労務士事務所が対応します。",
  },
  {
    q: "助成金と補助金はどちらに頼めばいい？",
  ...
  },
  {
    ...
    a: "対応します。日本語・英語・中国語（繁体字・簡体字）で、雇用契約・社会保険・育成就労（2027年4月施行）の受入準備を支援します。在留資格は四葉行政書士事務所（別事業体）が担当します。",
  },
  {
    q: "文京区以外も対応していますか？",
  ...
  {
    q: "中国語・英語で相談できますか？",
    a: "できます。代表は元毎日新聞中国総局長で、日本語・英語・中国語（繁体字・簡体字）に対応します。",
  },
];
