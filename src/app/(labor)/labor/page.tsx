        ...
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-b-3xl sm:mt-4 sm:rounded-3xl">
          ...
          <div className="md:absolute md:inset-0 md:flex md:items-center">
            <div className="bg-surface p-5 md:m-8 md:max-w-xl md:rounded-2xl md:bg-white/30 md:p-7 md:backdrop-blur-sm">
              ...
              {/* ★2026-08-14 リード改稿（浦松決定・最終＝案①）：キャッチ「人の手続きを、事業の力に。」は
                  維持し、内製化支援＝顧問料に含むを差し込む。既存客層（障害福祉・介護）を最優先。
                  いったん案②（「給与計算を、頼まないという頼み方も。」）で実装したが、浦松の指定で
                  案①に確定。「頼まないという頼み方」はコラム37とryokinのQAが担う。 */}
              <p className="mt-3 text-sm leading-relaxed text-text sm:text-base">
                <strong>東京都文京区小日向の社会保険労務士事務所です。</strong>人の手続きを、事業の力に。——顧問料だけで、労務のご相談は回数無制限。給与計算をfreeeで自社処理（内製）する体制づくりの支援も顧問料に含みます。障害福祉・介護の労務、処遇改善加算、助成金、外国人雇用に、元新聞記者の社労士が対応します。
              </p>
            </div>
          </div>
        </div>
