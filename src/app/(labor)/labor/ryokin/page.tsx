...
const SECTIONS: Section[] = [
  ...
  {
    title: "手続代行（適用）",
    // 2026-08-13：労働保険の概算保険料申告書を別建てにした。もともと新規適用29,700円に
    // 含めていたが、保険関係成立の日から50日以内という別の期限がある手続きなので、
    // 分けたほうが期限管理の意識づけになる。据え置いて別建てにすると合計46,200円＝55%の
    // 値上げになるため、新規適用を19,800円に下げて合計36,300円とした。
    // あわせて、事業を閉じるときの手続き（全喪・廃止・保険関係消滅）を新設した。
    // 料金表に「閉じるとき」の項目が1つも無く、スポット社労士くん・社労士クラウドの
    // いずれにも項目がないため（＝新規開業が客層）、相談レート11,000円/時から積算した。
    note: "労働保険の概算保険料申告書は、保険関係成立の日から50日以内に提出が必要です。新規適用と合わせてお引き受けする場合は36,300円になります。事業を閉じるときの手続きも承ります。被保険者の資格喪失届は1名ごとに別途申し受けます。",
    rows: [
      { name: "社会保険 新規適用", unit: "1件", price: "29,700円", value: 29700 },
      { name: "労働保険 新規適用", unit: "1件", price: "19,800円", value: 19800 },
      { name: "労働保険 概算保険料申告書", unit: "1件", price: "16,500円", value: 16500 },
      { name: "事業所 各種変更届", unit: "1件", price: "8,800円", value: 8800 },
      { name: "社会保険 適用事業所全喪届", unit: "1件", price: "16,500円", value: 16500 },
      { name: "雇用保険 適用事業所廃止届", unit: "1件", price: "8,800円", value: 8800 },
      { name: "労働保険 確定保険料申告・保険関係消滅", unit: "一式", price: "22,000円〜" },
    ],
  },
  {
    title: "手続代行（入退社・扶養）",
