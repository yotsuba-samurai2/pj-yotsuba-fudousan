  ...
  return (
    <div>
      <FAQJsonLd items={[
        ...
        { question: "外国人のビザ申請にも対応していますか？", answer: "はい、就労ビザ、経営・管理ビザ、配偶者ビザなど各種在留資格の取得・更新・変更に対応しています。多言語（日本語・英語・中国語）対応で外国人ご本人との直接やり取りも可能です。" },
        { question: "不動産と法務をまとめて相談できますか？", answer: "はい、四葉不動産では、四葉行政書士事務所と連携し、事務所の賃貸契約と会社設立手続きなどをワンストップで対応できます。" },
      ]} />
