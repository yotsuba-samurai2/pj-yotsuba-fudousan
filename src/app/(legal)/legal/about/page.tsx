...
// （%s | 四葉行政書士事務所）が付与＝ここでは書かない（重複防止）。
// title は表示ラベル（パンくず）専用＝長文化しない（JSON-LDのBreadcrumb名が崩れるため）。
const COPY: Record<
  LangCode,
  { title: string; metaTitle: string; desc: string; home: string }
> = {
  ja: {
    title: "事務所概要",
    metaTitle: "事務所概要｜文京区小日向・茗荷谷駅徒歩5分の行政書士",
    desc: "中国や台湾、タイで暮らした元新聞記者が、取材で培った情報収集力と文章力を活かして行政書士に。補助金申請、ビザ、会社設立、許認可に対応。文京区の四葉行政書士事務所の理念とバックグラウンドをご紹介します。",
    home: "ホーム",
  },
  en: {
    title: "About the Office",
    metaTitle: "About the Office | Administrative Scrivener in Bunkyo, Tokyo",
  ...
  "zh-tw": {
    title: "事務所簡介",
    metaTitle: "事務所簡介｜文京區小日向・茗荷谷站步行5分鐘的行政書士",
    desc: "曾派駐中國、台灣、泰國的前新聞記者，將採訪培養的資訊蒐集力與文字力投入行政書士工作。補助金申請、簽證、公司設立、許認可均可對應。為您介紹東京文京區・四葉行政書士事務所的理念與背景。",
    home: "首頁",
  },
  zh: {
    title: "事务所简介",
    metaTitle: "事务所简介｜文京区小日向・茗荷谷站步行5分钟的行政书士",
    desc: "曾派驻中国、台湾、泰国的前新闻记者，将采访培养的信息收集力与文字力投入行政书士工作。补助金申请、签证、公司设立、许认可均可对应。为您介绍东京文京区・四葉行政書士事務所的理念与背景。",
    home: "首页",
  },
};
